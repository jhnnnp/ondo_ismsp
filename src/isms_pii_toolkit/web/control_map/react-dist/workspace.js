const xs="isms-p-portfolio-assessment-v1",Is="isms-p-portfolio-checks-v2",Ts="isms-p-portfolio-domain-checks-v1",Rs="isms-p-quest-checks-v1",Ps="isms-p-control-evidence-v1",Ms="isms-p-input-confidence-v1",tt="isms-p-analysis-history-v1",Ns="isms-p-organization-profile-v1",Ds="isms-p-diagnosis-sessions-v1",_={unknown:"미점검",none:"미이행",partial:"부분 이행",done:"이행",evidenced:"이행",na:"해당 없음"},V={reviewed:"검토",policy:"정책",implemented:"구현",evidence:"증적"},qs={reviewed:"검토",policy:"정책/절차",implemented:"구현/운영",evidence:"증적"},J={1:"관리체계",2:"보호대책",3:"개인정보"},Yn={unknown:"모름",assumed:"추정",confirmed:"확인됨"},rs={assess:"물리 통제(전산실) 적용 여부만 고르면 됩니다. 인증 맞춤이 아니라 점검 범위 설정입니다.",analyze:"왼쪽 통제 항목에서 항목을 고르고, 오른쪽 카드에 진단 상태를 남기세요."},Le={assess:"점검 범위",analyze:"자가진단"},os={assess:"1단계 · 범위",analyze:"2단계 · 진단"},Pe={headcountBand:"1-50",industry:"technology",piiVolume:"low",usesCloud:!0,hasOnPremFacility:!1,usesOutsourcing:!1,usesRemoteAccess:!1,processesRrn:!1};function Bs(e){const t=Math.max(0,Math.floor(Number(e)||0)),s=Math.floor(t/86400),n=Math.floor(t%86400/3600),a=Math.floor(t%3600/60);return s>0?`${s}일 ${n}시간`:n>0?`${n}시간`:a>0?`${a}분`:"1분 미만"}function Qn(e){return`${Bs(e)} 남음`}function Et(e,t=Date.now()){if(!e)return 0;const s=Date.parse(e);return Number.isNaN(s)?0:Math.max(0,Math.floor((s-t)/1e3))}function Xn(e,t=Date.now()){const s=!!e?.active,n=s&&e?.kind==="invite",a=Et(e?.expiresAt,t);return n?{active:!0,meta:"등록됨",label:"초대권이 등록되었습니다."}:s&&a>0?{active:!0,meta:Bs(a),label:`사용권 ${Qn(a)}`}:e?.expiresAt?{active:!1,expired:!0,meta:"만료",label:"사용권이 만료되었습니다. 다시 등록하세요."}:{active:!1,expired:!1,meta:"미등록",label:"사용권을 등록하세요."}}function P(e){return document.getElementById(e)}const qt="is-workspace-locked";let R={required:!0,workspaceRequired:!0,active:!1,remainingSeconds:0,expiresAt:null,durationDays:null},vt=0,ne=null,Me=null;function st(){const e=P("pageHeadPass"),t=P("pageHeadPassLabel"),s=P("pageHeadPassMeta");if(!e||!t||!s)return;if(!R.required){e.hidden=!0;return}e.hidden=!1;const n=Xn(R);e.classList.toggle("is-active",n.active),e.classList.toggle("is-expired",!!n.expired),e.classList.toggle("is-empty",!n.active&&!n.expired),t.textContent="사용권",s.textContent=n.meta,e.setAttribute("aria-label",n.label),document.querySelectorAll("[data-write-ai-report]").forEach(a=>{n.active||!R.required?(a.removeAttribute("data-access-required"),a.removeAttribute("title")):(a.setAttribute("data-access-required","true"),a.setAttribute("title","클릭하여 사용권을 등록한 뒤 AI 초안을 작성하세요."))})}function Os(e){const t=P("workspaceAccessGate");Array.from(document.body.children).forEach(s=>{s!==t&&(e?s.setAttribute("inert",""):s.removeAttribute("inert"))})}function Bt(){document.documentElement.classList.add(qt);const e=P("workspaceAccessGate");e&&(e.setAttribute("aria-hidden","false"),e.removeAttribute("inert")),Os(!0);const t=P("workspaceAccessInput");t&&document.activeElement!==t&&t.focus()}function js(){if(document.documentElement.classList.remove(qt),P("workspaceAccessGate")?.setAttribute("aria-hidden","true"),Os(!1),Me){const t=Me;Me=null,t(!0)}}function Hs(){return new Promise(e=>{const t=Me;Me=s=>{t?.(s),e(s)}})}function Fs(e=R){return!!e.workspaceRequired&&!e.active}function Ot(e=R){Fs(e)?Bt():js()}function zs(){if(window.clearInterval(vt),!R.required||!R.expiresAt)return;const e=Et(R.expiresAt);if(e<=0){R={...R,active:!1,remainingSeconds:0},st(),Ot(R);return}const t=e<3600?1e3:3e4;vt=window.setInterval(()=>{st(),Et(R.expiresAt)<=0&&(window.clearInterval(vt),jt())},t)}async function jt(){try{const e=await fetch("/access/status",{credentials:"same-origin"});if(!e.ok)throw new Error("status");R=await e.json()}catch{R={required:!0,workspaceRequired:!0,active:!1,remainingSeconds:0,expiresAt:null,durationDays:null}}return st(),zs(),Ot(R),R}async function Zn(e){const t=await fetch("/access/register",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e})}),s=await t.json().catch(()=>({}));if(!t.ok)throw new Error(s.detail||"사용권을 등록하지 못했습니다.");return R=s,st(),zs(),Ot(R),R}function Ke(e=!1){if(P("accessPassDialog")?.close(),ne){const s=ne;ne=null,s(e)}}function _s(e,t,s,n){const a=P(e),r=P(t),o=P(s);!a||a.dataset.bound==="1"||(a.dataset.bound="1",a.addEventListener("submit",async l=>{l.preventDefault();const d=String(r?.value||"").trim();if(o&&(o.hidden=!0),d.length<16){o&&(o.hidden=!1,o.textContent="발급받은 초대 코드를 그대로 붙여넣으세요."),r?.focus();return}const u=P(n);u&&(u.disabled=!0);try{await Zn(d),r&&(r.value=""),e==="accessPassForm"&&Ke(!0)}catch(f){o&&(o.hidden=!1,o.textContent=f.message||"사용권을 등록하지 못했습니다.")}finally{u&&(u.disabled=!1)}}))}function Us(){const e=P("accessPassDialog");_s("accessPassForm","accessPassInput","accessPassError","accessPassSubmitBtn"),!(!e||e.dataset.bound==="1")&&(e.dataset.bound="1",e.addEventListener("click",t=>{t.target===e&&Ke(!1)}),e.addEventListener("cancel",t=>{t.preventDefault(),Ke(!1)}),P("accessPassCancelBtn")?.addEventListener("click",()=>Ke(!1)))}function Gs(){_s("workspaceAccessForm","workspaceAccessInput","workspaceAccessError","workspaceAccessSubmitBtn")}function Lt(){Us();const e=P("accessPassDialog"),t=P("accessPassInput"),s=P("accessPassError");return e?(s&&(s.hidden=!0),e.open?ne?new Promise(n=>{const a=ne;ne=r=>{a(r),n(r)}}):Promise.resolve(!1):new Promise(n=>{ne=n,e.showModal(),t?.focus(),t?.select()})):Promise.resolve(!1)}async function Ws(){const e=await jt();return!e.required||e.active?!0:document.documentElement.classList.contains(qt)?Hs():Lt()}async function ea(){Gs();const e=await jt();return!e.workspaceRequired||e.active?(js(),!0):(Bt(),Hs())}function ta(){Us(),Gs(),P("pageHeadPass")?.addEventListener("click",()=>{Lt()}),window.addEventListener("access-pass:required",()=>{Fs()?Bt():Lt()});const e=window.fetch.bind(window);window.fetch=async(t,s)=>{const n=await e(t,s);try{const a=String(typeof t=="string"?t:t?.url||""),r=new URL(a,window.location.origin).pathname;n.status===403&&(r==="/controls/report"||r==="/controls/report/rewrite")&&window.dispatchEvent(new CustomEvent("access-pass:required"))}catch{}return n}}const p=e=>document.getElementById(e);async function Se(e,t){const s=await fetch(e,t);if(!s.ok)throw new Error(await s.text());return s.json()}let ht=null;function $(e,t={}){const s=p("toast");if(!s)return;const n=String(e||"").trim();if(!n)return;const a=/실패|오류|불러오지 못/.test(n)?"error":/찾을 수 없|없습니다|먼저|필요|변경되었습니다/.test(n)?"warning":"success",r=t.tone||a,o=r==="warning"?{title:"확인 필요",icon:"!"}:r==="error"?{title:"처리 실패",icon:"!"}:{title:"",icon:"✓"},l=t.title??o.title,d=s.querySelector(".toast-copy strong");s.dataset.tone=r,s.querySelector(".toast-icon").textContent=o.icon,d.textContent=l,d.hidden=!l,s.querySelector(".toast-copy p").textContent=n;const u=t.duration||(r==="success"?2200:4e3);s.style.setProperty("--toast-duration",`${u}ms`),s.classList.remove("show"),s.offsetWidth,s.classList.add("show"),window.clearTimeout(ht),ht=window.setTimeout(()=>s.classList.remove("show"),u),s.querySelector(".toast-close").onclick=()=>{window.clearTimeout(ht),s.classList.remove("show")}}function Ht({title:e="계속 진행할까요?",message:t="이 작업을 진행하기 전에 내용을 확인해 주세요.",confirmLabel:s="확인",cancelLabel:n="취소",tone:a="default"}={}){let r=p("appConfirmDialog");return r||(r=document.createElement("dialog"),r.id="appConfirmDialog",r.className="app-confirm-dialog",r.setAttribute("aria-labelledby","appConfirmTitle"),r.setAttribute("aria-describedby","appConfirmMessage"),r.innerHTML=`
      ...
      </form>`,document.body.append(r),r.addEventListener("click",o=>{o.target===r&&r.close("cancel")})),r.dataset.tone=a,r.querySelector(".app-confirm-copy > span").textContent=a==="danger"?"삭제 확인":"확인",r.querySelector("#appConfirmTitle").textContent=e,r.querySelector("#appConfirmMessage").textContent=t,r.querySelector(".app-confirm-cancel").textContent=n,r.querySelector(".app-confirm-submit").textContent=s,r.showModal(),new Promise(o=>{r.addEventListener("close",()=>o(r.returnValue==="confirm"),{once:!0})})}function sa(e){return new Promise(t=>setTimeout(t,e))}function c(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const i={currentView:"assess",diagnosisSessions:[],activeSessionId:null,allControls:[],checklist:[],assessments:{},controlChecks:{},controlEvidence:{},domainChecks:{},domainTouched:{},analysis:null,analysisHistory:[],analysisStale:!1,lastAiExecutiveReport:null,aiReportStale:!1,aiReportWriting:!1,reportReview:{},reportReturn:null,dashboard:null,areaFilter:"all",levelFilter:"all",assessSearch:"",expandedRows:new Set,collapsedCategories:new Set,activeCategoryId:null,categoriesBootstrapped:!1,analyzeSection:"actions",analyzeDetailTab:"problem",cascadeExpanded:!1,problemFiltersOpen:!1,detailReturnContext:null,expandedGapInline:{},expandedProblemCascade:new Set,expandedProblemGroups:new Set,expandedProblemItems:new Set,problemAreaFilter:"all",problemLevelFilter:"all",problemSeverityFilter:"all",problemSourceFilter:"all",problemChecklistQuery:"",problemViewMode:"all",selectedProblemCategory:null,selectedProblemControl:null,multigapSeverityFilter:"all",selectedMultigapTheme:null,expandedMultigapThemes:new Set,gapSearch:"",gapLevelFilter:"all",expandedGaps:new Set,expandedMultigaps:new Set,expandedProblemClusters:new Set,gapRevealPending:!1,analyzeScenarioId:null,sessionBundleMode:"chain",sessionSelectedControlId:null,pendingDoneEvidenceControlId:null,sessionCollapsedCategories:new Set,organizationProfile:null,pendingProfile:null,scopeDraft:null,questChecks:{},inputConfidence:{},legalBasisCache:{}},na=["assessments","controlChecks","controlEvidence","domainChecks","domainTouched","questChecks","inputConfidence","reportReview"];function he(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}function yt(e){return JSON.parse(JSON.stringify(e))}function Vs(){return globalThis.crypto?.randomUUID?globalThis.crypto.randomUUID():`diagnosis-${Date.now()}-${Math.random().toString(36).slice(2,10)}`}function Ft(){return{assessments:{},controlChecks:{},controlEvidence:{},domainChecks:{},domainTouched:{},questChecks:{},inputConfidence:{},reportReview:{},analysisHistory:[],organizationProfile:null,sessionSelectedControlId:null}}function fe(e){const t=he(e),s=Ft();na.forEach(r=>{s[r]=yt(he(t[r]))});const n=he(t.controlEvidence),a={};return Object.entries(n).forEach(([r,o])=>{Array.isArray(o)&&(a[r]=o.filter(l=>l&&typeof l=="object"&&String(l.title||"").trim()).map(l=>({id:String(l.id||`ev-${r}-${Math.random().toString(36).slice(2,8)}`),title:String(l.title||"").trim(),url:String(l.url||"").trim(),note:String(l.note||"").trim(),createdAt:String(l.createdAt||new Date().toISOString())})))}),s.controlEvidence=a,s.analysisHistory=Array.isArray(t.analysisHistory)?yt(t.analysisHistory.slice(0,8)):[],s.organizationProfile=yt(he(t.organizationProfile)),Object.keys(s.organizationProfile).length||(s.organizationProfile=null),s.sessionSelectedControlId=typeof t.sessionSelectedControlId=="string"&&t.sessionSelectedControlId.trim()||null,s}const Ks=48;function Js(e,t="진단"){return String(e||"").replace(/\s+/g," ").trim().slice(0,Ks)||t}function Ae({id:e=Vs(),name:t="새 진단",now:s=new Date().toISOString(),data:n=Ft()}={}){return{id:e,name:Js(t),createdAt:s,updatedAt:s,data:fe(n)}}function aa(e,{id:t=Vs(),now:s=new Date().toISOString()}={}){return Ae({id:t,name:`${e?.name||"진단"} 복사본`,now:s,data:fe(e?.data)})}function Ys(e,t=101){const s=he(e?.data?.assessments),n=Object.values(s),a=n.filter(d=>d==="na").length,r=n.filter(d=>d&&d!=="unknown"&&d!=="na").length,o=Math.max(t-a,0),l=o?Math.round(r/o*100):0;return{reviewed:r,applicable:o,na:a,percent:l}}function ia(e){const t=he(e),s=Array.isArray(t.sessions)?t.sessions.filter(n=>n?.id).map(n=>{const a=Ae({id:String(n.id),name:String(n.name||"진단"),now:String(n.createdAt||n.updatedAt||new Date().toISOString()),data:n.data});return a.updatedAt=String(n.updatedAt||a.createdAt),a}):[];return{version:1,sessions:s,activeSessionId:ra(t,s)}}function ra(e,t){const s=typeof e?.activeSessionId=="string"?e.activeSessionId:null;return s&&t.some(n=>n.id===s)?s:null}function oa(){return globalThis.crypto?.randomUUID?globalThis.crypto.randomUUID():`ev-${Date.now()}-${Math.random().toString(36).slice(2,8)}`}function zt(e){const t=i.controlEvidence?.[e];return Array.isArray(t)?t:[]}function Y(e){return zt(e).length>0}function Qs(e){return i.controlEvidence||(i.controlEvidence={}),Array.isArray(i.controlEvidence[e])||(i.controlEvidence[e]=[]),i.controlEvidence[e]}function la(e,{title:t,url:s="",note:n=""}={}){const a=String(t||"").trim();if(!a)return{ok:!1,reason:"empty_title"};const r=String(s||"").trim(),o=String(n||"").trim(),l={id:oa(),title:a,url:r,note:o,createdAt:new Date().toISOString()};return Qs(e).push(l),{ok:!0,item:l}}function ca(e,t){const n=Qs(e).filter(a=>a.id!==t);return i.controlEvidence[e]=n,n.length}function L(e){const t=i.assessments[e]||"unknown";return t==="evidenced"?"done":t}function Xs(e,t){if(!e||!e.reviewed)return"unknown";const s=!!e.evidence&&(t?Y(t):!0);return e.policy&&e.implemented&&s?"done":e.policy||e.implemented?"partial":"none"}function _t(e){return e==="evidenced"||e==="done"?{reviewed:!0,policy:!0,implemented:!0,evidence:!0}:e==="partial"?{reviewed:!0,policy:!0,implemented:!1,evidence:!1}:e==="none"?{reviewed:!0,policy:!1,implemented:!1,evidence:!1}:{reviewed:!1,policy:!1,implemented:!1,evidence:!1}}function Zs(e,t){const s={...e};return t&&!Y(t)&&(s.evidence=!1),s.evidence&&(s.reviewed=!0,s.policy=!0,s.implemented=!0),(s.policy||s.implemented)&&!s.reviewed&&(s.reviewed=!0),s.reviewed||(s.policy=!1,s.implemented=!1,s.evidence=!1),s}function ls(e){return String(e||"").split(".").map(t=>Number(t)||0)}function ke(e,t){const s=ls(e),n=ls(t),a=Math.max(s.length,n.length);for(let r=0;r<a;r+=1){const o=(s[r]||0)-(n[r]||0);if(o)return o}return 0}function xt(e){const t=new Map;return e.forEach(s=>{const n=s.categoryId||"기타";t.has(n)||t.set(n,{categoryId:n,categoryName:s.categoryName||n,areaId:s.areaId,areaName:s.areaName||"",controls:[]}),t.get(n).controls.push(s)}),Array.from(t.values()).sort((s,n)=>ke(s.categoryId,n.categoryId))}function nt(e){const t=e.length,s=e.filter(a=>L(a.id)!=="unknown").length,n=t?Math.round(s/t*100):0;return{total:t,reviewed:s,pct:n}}function da(){new Set([...Object.keys(i.controlChecks||{}),...Object.keys(i.assessments||{}),...Object.keys(i.controlEvidence||{})]).forEach(t=>{if(i.assessments[t]==="na")return;i.assessments[t]==="evidenced"&&(i.assessments[t]="done");const s={...i.controlChecks[t]||_t(i.assessments[t]||"unknown")};s.evidence=Y(t);const n=Zs(s,t);i.controlChecks[t]=n,i.assessments[t]=Xs(n,t)})}const en="isms-p-diagnosis-backup",It=1;function Je(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function ua(e,t=new Date().toISOString()){if(!Je(e)||!String(e.id||"").trim())throw new Error("내보낼 진단을 찾을 수 없습니다.");return{format:en,version:It,exportedAt:t,notice:"사용자가 입력한 참고용 자가진단 백업이며 인증 적합성을 증명하지 않습니다.",session:{name:String(e.name||"진단"),createdAt:String(e.createdAt||t),updatedAt:String(e.updatedAt||t),data:fe(e.data)}}}function pa(e,t=101){let s;try{s=typeof e=="string"?JSON.parse(e):e}catch{throw new Error("JSON 형식의 진단 백업 파일이 아닙니다.")}if(!Je(s)||s.format!==en)throw new Error("이 프로젝트에서 만든 진단 백업 파일이 아닙니다.");if(s.version!==It)throw new Error(`지원하지 않는 백업 버전입니다. 현재 지원 버전: ${It}`);const n=Je(s.session);if(!n||!Je(n.data))throw new Error("백업 파일에 진단 데이터가 없습니다.");const a=fe(n.data),r=Ae({name:String(n.name||"가져온 진단"),data:a});return{name:r.name,originalCreatedAt:String(n.createdAt||""),originalUpdatedAt:String(n.updatedAt||""),exportedAt:String(s.exportedAt||""),data:a,progress:Ys(r,t)}}function fa(e,t=[]){const s=new Set(t),n=`${String(e||"진단").trim()||"진단"} (가져옴)`;if(!s.has(n))return n;let a=2;for(;s.has(`${n} ${a}`);)a+=1;return`${n} ${a}`}function ga(e,t=[],s=new Date().toISOString()){return Ae({name:fa(e?.name,t),now:s,data:e?.data})}function K(e,t){try{const s=localStorage.getItem(e);return s?JSON.parse(s):t}catch{return t}}function ee(){localStorage.setItem(Ds,JSON.stringify({version:1,sessions:i.diagnosisSessions,activeSessionId:i.activeSessionId}))}function ma(){return fe({assessments:K(xs,{}),controlChecks:K(Is,{}),controlEvidence:K(Ps,{}),domainChecks:K(Ts,{}),questChecks:K(Rs,{}),inputConfidence:K(Ms,{}),reportReview:{},analysisHistory:K(tt,[]),organizationProfile:K(Ns,null)})}function va(e){return!!(e.organizationProfile||Object.values(e).filter(t=>t&&typeof t=="object").some(t=>Object.keys(t).length))}function ha(){return fe({assessments:i.assessments,controlChecks:i.controlChecks,controlEvidence:i.controlEvidence,domainChecks:i.domainChecks,domainTouched:i.domainTouched,questChecks:i.questChecks,inputConfidence:i.inputConfidence,reportReview:{},analysisHistory:i.analysisHistory,organizationProfile:i.organizationProfile,sessionSelectedControlId:i.sessionSelectedControlId})}function ya(e){const t=fe(e);i.assessments=t.assessments,i.controlChecks=t.controlChecks,i.controlEvidence=t.controlEvidence,i.domainChecks=t.domainChecks,i.domainTouched=t.domainTouched,i.questChecks=t.questChecks,i.inputConfidence=t.inputConfidence,i.reportReview={},i.analysisHistory=t.analysisHistory,i.organizationProfile=t.organizationProfile?{...Pe,...t.organizationProfile,usesOutsourcing:!1,usesRemoteAccess:!1,processesRrn:!1}:null,i.sessionSelectedControlId=t.sessionSelectedControlId,i.analysis=null,i.analysisStale=!1,i.lastAiExecutiveReport=null,i.aiReportStale=!1,i.aiReportWriting=!1,i.reportReturn=null,i.currentView="assess",i.areaFilter="all",i.levelFilter="all",i.assessSearch="",i.expandedRows=new Set,i.collapsedCategories=new Set,i.activeCategoryId=null,i.categoriesBootstrapped=!1,i.analyzeSection="actions",i.expandedProblemGroups=new Set,i.expandedProblemItems=new Set,i.expandedGaps=new Set,i.expandedMultigaps=new Set,i.gapSearch="",i.scopeDraft=null,i.analyzeScenarioId=null,i.sessionBundleMode="chain",da()}function ba(){const e=K(Ds,null);if(e){const s=ia(e);return i.diagnosisSessions=s.sessions,i.activeSessionId=s.activeSessionId,i.diagnosisSessions}const t=ma();return i.diagnosisSessions=va(t)?[Ae({name:"기존 진단",data:t})]:[],i.activeSessionId=null,ee(),i.diagnosisSessions}function Ut(e){const t=i.diagnosisSessions.find(s=>s.id===e);return t?(i.activeSessionId=t.id,ya(t.data),ee(),t):null}function wa(){const e=new Set(i.diagnosisSessions.map(n=>n.name));let t=1;for(;e.has(`진단 ${t}`);)t+=1;const s=Ae({name:`진단 ${t}`,data:Ft()});return i.diagnosisSessions.unshift(s),ee(),Ut(s.id),s}function $a(e){const t=i.diagnosisSessions.find(n=>n.id===e);if(!t)return null;const s=aa(t);return i.diagnosisSessions.unshift(s),ee(),s}function Sa(e,t){const s=i.diagnosisSessions.findIndex(o=>o.id===e);if(s<0)return null;const n=i.diagnosisSessions[s],a=Js(t,n.name);if(a===n.name)return n;const r={...n,name:a,updatedAt:new Date().toISOString()};return i.diagnosisSessions[s]=r,ee(),r}function ka(e){i.activeSessionId===e&&Ue();const t=i.diagnosisSessions.find(s=>s.id===e);if(!t)throw new Error("내보낼 진단을 찾을 수 없습니다.");return ua(t)}function Ca(e){return pa(e,i.checklist?.length||101)}function Aa(e){const t=ga(e,i.diagnosisSessions.map(s=>s.name));return i.diagnosisSessions.unshift(t),ee(),t}function Ea(e){const t=i.diagnosisSessions.length;return i.diagnosisSessions=i.diagnosisSessions.filter(s=>s.id!==e),i.activeSessionId===e&&(i.activeSessionId=null),i.diagnosisSessions.length===t?!1:(ee(),!0)}function Ue(){if(!i.activeSessionId)return;const e=i.diagnosisSessions.findIndex(t=>t.id===i.activeSessionId);e<0||(i.diagnosisSessions[e]={...i.diagnosisSessions[e],updatedAt:new Date().toISOString(),data:ha()},ee())}function ge(){if(i.activeSessionId){Ue();return}localStorage.setItem(xs,JSON.stringify(i.assessments)),localStorage.setItem(Is,JSON.stringify(i.controlChecks)),localStorage.setItem(Ps,JSON.stringify(i.controlEvidence||{})),localStorage.setItem(Ts,JSON.stringify(i.domainChecks)),localStorage.setItem(Rs,JSON.stringify(i.questChecks||{})),localStorage.setItem(Ms,JSON.stringify(i.inputConfidence||{}))}function La(e){if(i.organizationProfile=e,i.activeSessionId){Ue();return}localStorage.setItem(Ns,JSON.stringify(e))}const tn=[["제거","삭제","해지","말소","회수","폐기"],["계정","아이디","userid"],["불필요","미사용","휴면"],["패치","업데이트","보안패치","핫픽스"],["비밀번호","패스워드","password"],["권한","접근권한"],["관리자","root","admin","특권"],["암호화","tls","ssl"],["로그","접속기록","감사로그"],["백업","복구"],["악성코드","바이러스","랜섬웨어","백신"],["퇴직","퇴사","이직"],["외주","수탁","위탁","외부자"],["원격","vpn","재택"],["인증","mfa","otp","다중인증"]],xa=["불필요","주기적","사용자","보안패치","보안","적용","점검","파일","최소","그룹","방화벽","개인정보","파기","보유기간","화면보호기","취약점","재직","계약종료","계약만료","계약","직무변경","필요성","잔존"],Ia=[...new Set([...tn.flat(),...xa])].filter(e=>e.length>=2).sort((e,t)=>t.length-e.length),sn=new Map;tn.forEach(e=>{e.forEach(t=>{sn.set(t,e)})});function q(e){return String(e||"").toLowerCase().normalize("NFC").replace(/[\s\u00a0·.,;:()[\]{}'"'`~!@#$%^&*_+=|\\/<>?-]/g,"")}function N(e,t){if(e!=null){if(typeof e=="string"||typeof e=="number"){const s=String(e).trim();s&&t.push(s);return}if(Array.isArray(e)){e.forEach(s=>N(s,t));return}typeof e=="object"&&["item","label","title","text","problem","phrase","concepts"].forEach(s=>{e[s]&&N(e[s],t)})}}function nn(e){const t=[];return N(e?.id,t),N(e?.title,t),N(e?.areaName,t),N(e?.categoryName,t),N(e?.tags,t),N(e?.checklistItems,t),N(e?.officialRequirement,t),N(e?.officialEvidenceExamples,t),N(e?.recommendedActions,t),N(e?.riskIfMissing,t),N(e?.searchHints,t),N(e?.searchEntries,t),N(e?.searchIntents,t),N(e?.officialChecks,t),q(t.join(" "))}function cs(e){const t=[];let s=0;for(;s<e.length;){let n="";for(const a of Ia)if(e.startsWith(a,s)){n=a;break}n?(t.push(n),s+=n.length):s+=1}return t}function Ta(e){let t=q(e);const s=["해주세요","인가요","입니다","합니다","했어요","해요","되어","됐다","있음","없음"];for(const n of s)if(t.length>n.length+1&&t.endsWith(n)){t=t.slice(0,-n.length);break}for(const n of["에서","으로","라고","까지","부터","이","가","을","를","은","는","의","에","로","도","만"])if(t.length>n.length+1&&t.endsWith(n)){t=t.slice(0,-n.length);break}return t}function an(e){const t=String(e||"").trim().toLowerCase().normalize("NFC");if(!t)return[];const s=t.split(/[\s,./·]+/).map(Ta).filter(r=>r.length>=2);if(s.length>1){const r=s.flatMap(o=>{const l=cs(o);return l.length?l:[o]});return[...new Set(r)]}const n=q(t),a=cs(n);return a.length>=2?[...new Set(a)]:n?[n]:[]}function Ra(e){const t=q(e),s=sn.get(t);return s?[...new Set(s.map(n=>q(n)))]:[t]}function ye(e,t){return Ra(t).some(s=>s&&e.includes(s))}function rn(e,t){const s=q(t);return s?(e?.searchIntents||[]).reduce((n,a)=>{const r=[...new Set((a?.concepts||[]).map(q).filter(Boolean))];if(!r.length)return n;const o=r.filter(m=>s.includes(m)).length,l=r.length===1?1:Math.min(2,r.length);if(o<l)return n;const d=o/r.length,u=Math.min(r.reduce((m,g)=>m+g.length,0),18)/18,f=Math.max(0,Math.min(100,Number(a?.weight)||0));return Math.max(n,42+d*28+u*12+f*.18)},0):0}const Pa=new Set(["재직","계약","계약종료","계약만료","직무변경","필요성","잔존","퇴사","퇴직","외주"]);function Ma(e,t){return t.length<3?!1:(e?.searchEntries||[]).filter(n=>Number(n?.weight)>=90&&n?.text).some(n=>{const a=q(n.text);return t.some(r=>Pa.has(r)&&ye(a,r))})}function Na(e,t){if(!e||!t)return 0;const s=e.length,n=t.length;let a=0,r=new Array(n+1).fill(0);for(let o=1;o<=s;o+=1){const l=new Array(n+1).fill(0);for(let d=1;d<=n;d+=1)e[o-1]===t[d-1]&&(l[d]=r[d-1]+1,l[d]>a&&(a=l[d]));r=l}return a}function on(e,t){const s=String(t||"").trim();if(!s)return!0;const n=q(s);if(!n)return!0;const a=nn(e);if(a.includes(n))return!0;const r=String(e?.id||"").toLowerCase();if(r&&r.includes(s.toLowerCase())||/^\d+(\.\d+)*$/.test(s)&&q(r)===n)return!0;const o=an(s);if(rn(e,s)>=60)return!0;if(o.length>=2){const l=o.filter(d=>ye(a,d)).length;return Ma(e,o)?!0:o.length===2?l===2:l>=2&&l/o.length>=.6}return n.length>=6?Na(n,a)>=Math.min(6,Math.ceil(n.length*.65)):a.includes(n)}function ds(e,t){const s=String(t||"").trim();if(!s)return 0;const n=q(s),a=q(e?.title);if(q(e?.id)===n||String(e?.id||"").toLowerCase()===s.toLowerCase())return 100;if(a.includes(n))return 90;const o=an(s),l=rn(e,s),d=(e?.searchHints||[]).map(y=>q(y)),u=(e?.searchEntries||[]).map(y=>({text:q(y?.text),weight:Math.max(0,Math.min(100,Number(y?.weight)||0))})).filter(y=>y.text),f=u.filter(y=>y.text.includes(n)).reduce((y,x)=>Math.max(y,x.weight),0);if(f)return Math.max(70+Math.round(f*.2),Math.round(l));const m=u.reduce((y,x)=>{if(!o.length)return y;const v=o.filter(k=>ye(x.text,k)).length;if(!v)return y;const S=v/o.length,w=Math.min(v,3)/3;return Math.max(y,S*38+w*22+x.weight*.18)},0);if(d.some(y=>y.includes(n)))return Math.max(90,Math.round(l));const h=o.filter(y=>ye(a,y)).length,b=o.filter(y=>d.some(x=>ye(x,y))).length,A=nn(e),E=o.filter(y=>ye(A,y)).length;return o.length&&h===o.length?Math.max(82,Math.round(m)):o.length&&b===o.length?Math.max(76,Math.round(m)):o.length&&E===o.length?Math.max(64,Math.round(m)):Math.max(Math.round(l),Math.round(m),E?35+Math.round(E/o.length*20):0)}function ln(e,t){const s=Array.isArray(e)?e:[];return String(t||"").trim()?[...s].sort((n,a)=>{const r=ds(a,t)-ds(n,t);return r||String(n.id).localeCompare(String(a.id),"en",{numeric:!0})}):s}function Gt(e){return on(e,i.assessSearch)}function Da(){const e={};return i.checklist.forEach(t=>{e[t.areaId]||(e[t.areaId]=t.areaName)}),e}function Ve(e){return i.checklist.filter(t=>e!=="all"&&t.areaId!==e||!Gt(t)?!1:i.levelFilter==="all"||L(t.id)===i.levelFilter).length}function qa(){return{all:Ve("all"),1:Ve("1"),2:Ve("2"),3:Ve("3")}}function Ba(){return i.checklist.filter(e=>i.areaFilter!=="all"&&e.areaId!==i.areaFilter?!1:Gt(e))}function us(){return i.areaFilter==="all"?i.checklist:i.checklist.filter(e=>e.areaId===i.areaFilter)}function cn(){return i.levelFilter!=="all"||!!i.assessSearch.trim()}function Oa(e){return i.checklist.filter(t=>i.areaFilter!=="all"&&t.areaId!==i.areaFilter||!Gt(t)?!1:e==="all"||L(t.id)===e).length}function ja(){return Object.fromEntries(["all","unknown","none","partial","done","na"].map(t=>[t,Oa(t)]))}function lt(){const e=Ba(),t=i.levelFilter==="all"?e:e.filter(s=>L(s.id)===i.levelFilter);return ln(t,i.assessSearch)}function dn(){return Object.values(i.assessments).filter(e=>e!=="unknown"&&e!=="na").length}function un(){const e=Object.keys(i.assessments).length||101,t=Object.values(i.assessments).filter(s=>s==="na").length;return Math.max(e-t,0)}function pn(e){return`<span class="status-pill level-${e}">${_[e]||e}</span>`}function ps(e){try{const t=new URL(e||"");return t.protocol!=="https:"||!["law.go.kr","www.law.go.kr"].includes(t.hostname)?"":t.href}catch{return""}}function xe(e){return String(e||"").replace(/개인 정보/g,"개인정보").replace(/정보 주체/g,"정보주체").replace(/공동 주택/g,"공동주택").replace(/관리 주체/g,"관리주체").replace(/주택 관리/g,"주택관리").replace(/관리 사무소/g,"관리사무소").replace(/입주자대표 회의/g,"입주자대표회의").replace(/개인정보 처리자/g,"개인정보처리자").replace(/\s+/g," ").trim()}function Ha(e){return String(e||"").replace(/\r\n?/g,`
...
`).trim()}function Fa(e){if(!/여부와/.test(e))return[e];const t=e.split(/\s*여부와\s+/);if(t.length!==2)return[e];const s=t[0].trim(),n=t[1].trim();return!s||!n?[e]:!/(여부|있는지|할지|인지|「)/.test(s)||!/(여부|「)/.test(n)?[e]:[/여부\??$/.test(s)?s:`${s} 여부`,n]}function za(e){if(e.length<160)return[e];const t=e.split(new RegExp("(?<=(?:합니다|됩니다|있습니다|없습니다|봅니다|판단됩니다|어렵습니다|해당하지 않습니다|요청함)\\.)\\s+"));return t.length>1?t.map(s=>s.trim()).filter(Boolean):[e]}function _a(e,t){return/^(행위 주체 내용|관리주체|질의 배경|관계 법령|결론)$/.test(e)||e.length<=40&&/(?:결정례|판례|구조도|법적 근거)$/.test(e)?!0:e.length<=16&&!/[.!?。?]$/.test(e)&&!/^[①-⑳가나다라마바사\d]/.test(e)&&/^[①-⑳]/.test(t||"")}function Tt(e){const t=Ha(e).split(/\n+/).map(u=>u.trim()).filter(u=>u&&!/^\d+\s*[•·]\s*$/.test(u)&&!/^[ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩ]+$/.test(u)).flatMap(u=>/^([가나다라마바사아자차카타파하]\.|[①-⑳]|\d{1,2}\.|-|※|<)/.test(u)?[u]:za(u));if(!t.length)return"";const s=[];let n=[],a=[],r="";const o=()=>{n.length&&(s.push(`<p>${c(xe(n.join(" ")))}</p>`),n=[])},l=()=>{if(!a.length)return;const u=r==="hangul",f=r==="bullet",m=f?"ul":"ol",g=u?"legal-hangul-list":f?"legal-bullet-list":"legal-reasoning-list";s.push(`<${m} class="${g}">${a.map(h=>`<li>${c(xe(h))}</li>`).join("")}</${m}>`),a=[],r=""},d=(u,f)=>{r&&r!==u&&l(),r=u,a.push(f)};return t.forEach((u,f)=>{const m=u.replace(/^<\s*([^>]+)\s*>$/,"$1").trim(),g=/^<\s*([^>]+)\s*>$/.test(u),h=m.match(/^([가나다라마바사아자차카타파하])\.\s*(.+)$/),b=m.match(/^(\d{1,2})\.\s+(.+)$/),A=m.match(/^([①-⑳])\s*(.+)$/),E=m.match(/^-\s*(.+)$/),y=m.match(/^※\s*(.+)$/),x=/^(?:[①-⑳]|\d{1,2}\.)\s*[∼~～]/.test(m),v=t[f+1]||"";if(x){o(),l(),s.push(`<p class="legal-note">${c(xe(m))}</p>`);return}if(g||_a(m,v)){o(),l(),s.push(`<h5>${c(xe(m))}</h5>`);return}if(y){o(),l(),s.push(`<p class="legal-note">${c(xe(y[1]))}</p>`);return}if(h){o(),d("hangul",h[2]);return}if(b||A||E){o(),d(E?"bullet":"decimal",(b||A||E)[b||A?2:1]);return}const S=Fa(m);if(S.length>1){o(),S.forEach(w=>d("decimal",w));return}if(a.length){const w=a[a.length-1];if(!(/[.)”’]$/.test(w)&&/^(이 |그 |따라서|그러므로|한편|반면|결론적으로|대법원|헌법재판소)/.test(m))){a[a.length-1]=`${w} ${m}`;return}}l(),n.push(m),(/[.!?。?][”’)]?$/.test(m)||/(?:합니다|됩니다|있습니다|없습니다|봅니다|판단됩니다|요청함)[.]?$/.test(m))&&o()}),o(),l(),`<div class="legal-prose legal-reasoning-content">${s.join("")}</div>`}function Ie(e,t,s){const n=Tt(t);return n?`<section class="legal-reading-section is-${s}"><h4>${c(e)}</h4>${n}</section>`:""}function Wt(e,t=i.legalBasisCache?.[e]){if(!t||t.status==="idle")return'<p class="today-detail-note">관련 법령과 법령해석을 불러오는 중입니다.</p>';if(t.status==="loading")return'<p class="today-detail-note" role="status">법적 근거를 불러오는 중...</p>';if(t.status==="error")return`
      <p class="legal-error">법적 근거를 불러오지 못했습니다.</p>
      <button type="button" class="legal-retry" data-retry-legal="${c(e)}">다시 시도</button>
    `;const s=t.data||{},n=(s.laws||[]).map((g,h)=>{const b=ps(g.sourceUrl);return`
    ...
    `}).join(""),a=(s.interpretations||[]).map(g=>{const h=ps(g.source?.originalUrl),b=g.warning||(g.temporalStatus==="REVIEW_REQUIRED"?"해석 이후 관련 법령이 개정되었을 수 있어 현재 적용 여부를 검토해야 합니다.":"");return`
  ...
  `}function Ua(){const e=qa(),t=Da(),s=p("areaFilterGroup");if(s){const r=[{id:"all",label:"전체"},{id:"1",label:J[1]},{id:"2",label:J[2]},{id:"3",label:J[3]}];s.innerHTML=r.map(o=>{const l=o.id==="all"?e.all:e[o.id]||0,d=o.id==="all"?`전체 ${l}개 통제`:`${t[o.id]||o.label} (${l}개)`;return`
    ...
    `).join("")}}function Ga(e,{ensureChecks:t,ensureDomainChecks:s}){const n=L(e.id),a=t(e.id),r=i.inputConfidence?.[e.id]||"unknown",o=i.expandedRows.has(e.id),l=e.checklistItems||[],d=o?s(e.id,l):i.domainChecks[e.id]||{},u=l.map((y,x)=>{const v=String(x+1),S=!!d[v];return o?`
      ...
      `:`<li><strong>${v}.</strong> ${c(y)}</li>`}).join(""),f=(e.recommendedActions||[]).map(y=>`<li>${c(y)}</li>`).join(""),m=(e.officialEvidenceExamples||[]).slice(0,6).map(y=>`<li>${c(y)}</li>`).join(""),g=zt(e.id),h=g.length?g.map(y=>`<li><strong>${c(y.title)}</strong>${y.url?` · ${c(y.url)}`:""}${y.note?` · ${c(y.note)}`:""}</li>`).join(""):"<li>등록된 증적 없음 (이행 판정에 필요)</li>",b=n==="evidenced"?"done":n,A=e.officialRequirement?`<div class="detail-block"><h3>인증기준 (안내서)</h3><p>${c(e.officialRequirement)}</p></div>`:"",E=o?`<div class="detail-block legal-basis-block">
          <h3>법적 근거 및 참고자료</h3>
      ...
      <div class="assess-row${o?" expanded":""}${b!=="unknown"&&b!=="na"?" is-reviewed":""}${b==="none"?" is-risk":""}" data-control="${e.id}">
        ...
        <span class="assess-expand-icon" aria-hidden="true">▾</span>
          ...
          <div class="audit-checks" aria-label="${e.id} 자체진단 체크 항목">
            ${Object.keys(V).map(y=>`
            <label class="audit-check" title="${e.id} ${qs[y]}">
  ...
  `}function Wa(e,t,s){const n=p("assessRailFilterHint");if(n){if(!cn()){n.hidden=!0,n.innerHTML="";return}n.hidden=!1,n.innerHTML=`
    필터 적용 중 — 목록 <strong>${e}개</strong> /
    분류 트리 ${t}개 기준.
    <button type="button" id="resetAssessFiltersBtn">필터 초기화</button>
  `,n.querySelector("#resetAssessFiltersBtn")?.addEventListener("click",()=>{s()})}}function Ye(e,t){const s=p("assessCategoryNav");if(!s)return;const n=cn();if(!e.length){s.innerHTML='<p class="detail-empty">표시할 분류가 없습니다.</p>';return}const a=new Map;e.forEach(o=>{const l=o.areaId||"0";a.has(l)||a.set(l,{areaId:l,areaName:o.areaName||J[l]||"기타",groups:[]}),a.get(l).groups.push(o)});const r=Array.from(a.values()).sort((o,l)=>ke(o.areaId,l.areaId));s.innerHTML=r.map(o=>{const l=o.groups.reduce((f,m)=>f+m.controls.filter(g=>t.has(g.id)).length,0),d=o.groups.reduce((f,m)=>f+m.controls.length,0),u=n?`${l}/${d}`:String(d);return`
    <div class="assess-area-block">
      <div class="assess-area-label">
        <span>${J[o.areaId]||o.areaName}</span>
        <span>${u}</span>
      </div>
      ${o.groups.map(f=>{const m=f.controls.filter(E=>t.has(E.id)).length,g=nt(f.controls),h=n&&m===0,b=i.activeCategoryId===f.categoryId?" active":"",A=n?`${m}/${f.controls.length}`:`${g.reviewed}/${g.total} (${g.pct}%)`;return`
          <button type="button" class="assess-nav-item${b}${h?" is-dimmed":""}" data-jump-category="${f.categoryId}" title="${c(f.categoryName)}${n?` — 필터 ${m}개`:` (${g.pct}%)`}">
            <strong>${f.categoryId} ${f.categoryName}</strong>
            <span class="assess-nav-meta">${A}</span>
          </button>
        `}).join("")}
    </div>
  `}).join(""),s.querySelectorAll("[data-jump-category]").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.jumpCategory,u=(e.find(m=>m.categoryId===l)?.controls||[]).filter(m=>t.has(m.id));if(n&&!u.length){$("이 분류에는 현재 필터 조건에 맞는 통제가 없습니다.");return}i.activeCategoryId=l,i.collapsedCategories.delete(l);const f=document.querySelector(`[data-category-group="${l}"]`);f&&(f.classList.remove("collapsed"),f.scrollIntoView({behavior:"smooth",block:"start"})),Ye(e,t)})})}const H="/workspace",bt="/controls/map",U={sessions:{id:"sessions",path:H,title:"진단 관리"},scope:{id:"scope",path:`${H}/scope`,title:"점검 범위"},assessment:{id:"assessment",path:`${H}/assessment`,title:"자가진단",workspace:"assessment"},results:{id:"results",path:`${H}/results`,title:"진단 결과",workspace:"results"},evidence:{id:"evidence",path:`${H}/evidence`,title:"증적 관리",workspace:"evidence"},report:{id:"report",path:`${H}/report`,title:"보고서",workspace:"report"}};let fn=null;function Va(e){fn=e}function gn(e){return String(e||"").replace(/\/+$/,"")||"/"}function Ka(e){const t=gn(e);return t===bt||t.startsWith(`${bt}/`)?H+t.slice(bt.length):t}function ct(e=globalThis.location?.pathname){const t=Ka(e);return t===`${H}/sessions`?U.sessions:t===`${H}/dashboard`?U.assessment:Object.values(U).find(s=>gn(s.path)===t)||null}function le(e,t={}){fn?.(e,t)}function W(e){return i.controlChecks[e]||(i.controlChecks[e]=_t(i.assessments[e]||"unknown")),i.controlChecks[e]}function Vt(e,t){const s=t||[];if(i.domainChecks[e])s.forEach((n,a)=>{const r=String(a+1);r in i.domainChecks[e]||(i.domainChecks[e][r]=!1)});else{const n={},a=W(e),r=Object.keys(V);s.forEach((o,l)=>{const d=String(l+1),u=r[l];n[d]=u?!!a[u]:!1}),i.domainChecks[e]=n}return i.domainChecks[e]}function mn(e,t,s){const n=(i.checklist||[]).find(a=>a.id===e);Vt(e,n?.checklistItems||[]),i.domainChecks[e]||(i.domainChecks[e]={}),i.domainChecks[e][String(t)]=!!s,i.domainTouched[e]=!0,ge()}function vn(){const e={};return Object.keys(i.domainTouched||{}).forEach(t=>{i.domainChecks[t]&&(e[t]=i.domainChecks[t])}),Object.keys(e).length?e:null}function Ja(e){(i.inputConfidence?.[e]||"unknown")==="unknown"&&(i.inputConfidence[e]="assumed")}function Ce(e,t){const s=i.assessments[e],n=Zs(t,e);if(i.controlChecks[e]=n,s==="na"){i.assessments[e]="na";return}i.assessments[e]=Xs(n,e),i.assessments[e]!=="unknown"&&Ja(e)}function Ya(e){const t=new Set((e.applicabilityNotes||[]).map(s=>s.controlId).filter(Boolean));Object.keys(i.assessments).forEach(s=>{i.assessments[s]==="na"&&!t.has(s)&&(i.assessments[s]="unknown")}),t.forEach(s=>{i.assessments[s]="na"})}let G={},Rt=null;function Qa(e){try{const t=new URL(e||"");return t.protocol==="https:"&&["law.go.kr","www.law.go.kr"].includes(t.hostname)?t.href:""}catch{return""}}function Xa(e){return String(e||"").split(/\n+/).map(t=>t.trim()).filter(Boolean).map(t=>{const s=c(t);return/^제\d+조(?:의\d+)?(?:\(|$)/.test(t)?`<h3 class="legal-text-heading">${s}</h3>`:/^[①②③④⑤⑥⑦⑧⑨⑩]/.test(t)?`<p class="legal-text-clause">${s}</p>`:/^\d+[.．]\s*/.test(t)?`<p class="legal-text-item">${s}</p>`:/^[가-하][.．]\s*/.test(t)?`<p class="legal-text-subitem">${s}</p>`:`<p>${s}</p>`}).join("")}function Za(){let e=document.querySelector("#lawArticleDialog");return e||(e=document.createElement("dialog"),e.id="lawArticleDialog",e.className="app-modal legal-article-dialog",e.setAttribute("aria-labelledby","lawArticleDialogTitle"),e.innerHTML=`
  ...
  `,e.querySelector("[data-law-dialog-close]").addEventListener("click",()=>e.close()),e.addEventListener("click",t=>{t.target===e&&e.close()}),e.addEventListener("close",()=>{Rt?.focus(),Rt=null}),document.body.append(e),e)}function ei(e,t,s){const n=i.legalBasisCache?.[e]?.data?.laws?.[t];if(!n?.articleText){$("표시할 조문 본문이 없습니다.");return}const a=Za(),r=[n.lawName||"관련 법령",n.article].filter(Boolean).join(" "),o=[n.documentType,n.currentStatus,n.effectiveDate?`시행 ${n.effectiveDate}`:"",n.ministry,n.basisType==="COMMON_CERTIFICATION_BASIS"?"제도 공통 근거":"통제 직접 근거"].filter(Boolean),l=Qa(n.sourceUrl);a.querySelector("#lawArticleDialogTitle").textContent=r,a.querySelector(".legal-dialog-subtitle").textContent=n.articleTitle||"현행 조문 본문",a.querySelector(".legal-dialog-meta").innerHTML=o.map(d=>`<span>${c(d)}</span>`).join(""),a.querySelector(".legal-dialog-body").innerHTML=Xa(n.articleText),a.querySelector(".legal-dialog-footer").innerHTML=l?`<a class="legal-dialog-source" href="${c(l)}" target="_blank" rel="noopener noreferrer">국가법령정보센터에서 원문 보기 ↗</a>`:"",Rt=s,a.showModal()}function ti(e){e.querySelectorAll("[data-open-law-article]").forEach(t=>{t.addEventListener("click",()=>{ei(t.dataset.lawControl,Number(t.dataset.openLawArticle),t)})})}async function at(e,{force:t=!1}={}){const s=i.legalBasisCache?.[e];if(!t&&s?.status==="ready"){wt(e);return}if(!(!t&&s?.status==="loading")){i.legalBasisCache[e]={status:"loading"},wt(e);try{const n=await Se(`/controls/${encodeURIComponent(e)}/legal-basis`);i.legalBasisCache[e]={status:"ready",data:n}}catch(n){i.legalBasisCache[e]={status:"error",error:String(n?.message||n)}}wt(e)}}function wt(e){const t=document.querySelector(`[data-legal-basis="${CSS.escape(e)}"]`);t&&(t.innerHTML=Wt(e),t.querySelector("[data-retry-legal]")?.addEventListener("click",()=>{at(e,{force:!0})}),ti(t))}function si(e){G={...e}}function Ne(e){ge(),Kt(),ai(e),i.analysis?(G.renderConfirmationActions(i.analysis),G.renderStats(),G.markAnalysisStale?.()):i.currentView==="assess"&&Ee()}function hn(e,t,s){if(t==="evidence"&&s&&!Y(e)){$("증적 링크/메모를 먼저 등록하세요."),Ne(e);return}if(t==="evidence"&&!s&&Y(e)){$("등록된 증적이 있습니다. 목록에서 삭제한 뒤 해제하세요."),Ne(e);return}const n={...W(e),[t]:s};Ce(e,n),Ne(e)}function fs(e,t,{quiet:s=!1}={}){return la(e,t).ok?(Ce(e,{...W(e),evidence:!0}),i.sessionSelectedControlId=e,Ne(e),s||$(`${e} 증적을 등록했습니다.`),!0):($("증적 제목을 입력하세요."),!1)}function ni(e,t){return ca(e,t),Ce(e,{...W(e),evidence:Y(e)}),i.sessionSelectedControlId=e,Ne(e),$(Y(e)?"증적을 삭제했습니다.":"증적을 삭제해 부분 이행으로 조정됩니다."),!0}function ai(e){const t=document.querySelector(`#assessList .assess-row[data-control="${e}"]`);if(!t){i.currentView==="assess"&&Ee();return}const s=L(e),n=W(e);t.classList.toggle("is-reviewed",s!=="unknown"&&s!=="na"),t.classList.toggle("is-risk",s==="none");const a=t.querySelector(".assess-row-meta-line .status-pill");if(a){const o=document.createElement("div");o.innerHTML=pn(s),a.replaceWith(o.firstElementChild)}Object.keys(V).forEach(o=>{const l=t.querySelector(`input[data-check-control="${e}"][data-check-key="${o}"]`);l&&(l.checked=!!n[o])});const r=t.closest(".assess-category-group");if(r){const o=[...r.querySelectorAll(".assess-row")].map(g=>g.dataset.control),l=o.length,d=o.filter(g=>L(g)!=="unknown").length,u=l?Math.round(d/l*100):0,f=r.querySelector(".assess-category-progress strong"),m=r.querySelector(".assess-category-bar i");f&&(f.textContent=`${d}/${l}`),m&&(m.style.width=`${u}%`)}}function yn(e){const t=lt();return t.length?(t.forEach(s=>{Ce(s.id,e(W(s.id)))}),ge(),Kt(),Ee(),t.length):($("현재 필터에 해당하는 통제가 없습니다."),0)}function ii(e,t){const s=yn(n=>{const a={...n,[e]:t};return e!=="reviewed"&&t&&(a.reviewed=!0),e==="reviewed"&&!t&&(a.policy=!1,a.implemented=!1,a.evidence=!1),e==="evidence"&&t&&(a.policy=!0,a.implemented=!0),a});s&&$(`${V[e]} ${t?"체크":"해제"}: ${s}개`)}function ri(e){const s={all:{reviewed:!0,policy:!0,implemented:!0,evidence:!0},none:{reviewed:!1,policy:!1,implemented:!1,evidence:!1},reviewed:{reviewed:!0,policy:!1,implemented:!1,evidence:!1}}[e];if(!s)return;const n=yn(()=>({...s}));if(!n)return;$(`${{all:"전체 체크",none:"전체 해제",reviewed:"검토만 체크"}[e]}: ${n}개`)}function oi({keepArea:e=!0}={}){i.levelFilter="all",i.assessSearch="",p("assessSearch")&&(p("assessSearch").value=""),e||(i.areaFilter="all"),i.categoriesBootstrapped=!1,Ee()}function li(e){const t=lt();if(!t.length)return{checked:!1,indeterminate:!1};const s=t.filter(n=>W(n.id)[e]).length;return{checked:s===t.length,indeterminate:s>0&&s<t.length}}function ci(){const e=lt(),t=p("assessFilterSummary"),s=p("assessColBulk");if(!t||!s)return;const n=i.areaFilter==="all"?"전체 영역":J[i.areaFilter]||`영역 ${i.areaFilter}`,a=i.levelFilter==="all"?"전체 상태":_[i.levelFilter],r=i.assessSearch.trim()?` / 검색 "${i.assessSearch.trim()}"`:"";t.innerHTML=`<strong>${e.length}개</strong> 표시 / ${n} / ${a}${r}`,s.innerHTML=Object.keys(V).map(o=>`
    <label class="bulk-check-toggle" title="현재 목록 ${V[o]} 전체">
      <input type="checkbox" data-bulk-check="${o}">
      <span>${V[o]} 전체</span>
    </label>
  `).join(""),s.querySelectorAll("[data-bulk-check]").forEach(o=>{const l=o.dataset.bulkCheck,d=li(l);o.checked=d.checked,o.indeterminate=d.indeterminate,o.addEventListener("change",()=>{ii(l,o.checked)})})}function Kt(){const e=p("assessProgressLabel"),t=p("assessProgressPct"),s=p("assessProgressFill"),n=p("levelSummary");if(!e&&!t&&!s&&!n)return;const a=i.checklist.length?i.checklist.filter(d=>{const u=L(d.id);return u!=="unknown"&&u!=="na"}).length:dn(),r=i.checklist.length?i.checklist.filter(d=>L(d.id)!=="na").length:un(),o=r?Math.round(a/r*100):0;e&&(e.textContent=`응답 진행: ${a} / ${r}`),t&&(t.textContent=`${o}%`),s&&(s.style.width=`${o}%`);const l=Object.keys(_).reduce((d,u)=>(d[u]=0,d),{});(i.checklist.length?i.checklist:i.allControls).forEach(d=>{const u=L(d.id);l[u]=(l[u]||0)+1}),n&&(n.innerHTML=Object.keys(_).map(d=>`
      <div class="level-summary-item">
        <span class="level-${d}">${_[d]}</span>
        <strong>${l[d]||0}</strong>
      </div>
    `).join(""))}function di(e){return Ga(e,{ensureChecks:W,ensureDomainChecks:Vt})}function gs(e,t){Wa(e,t,()=>{oi({keepArea:!0})})}function Ee(){const e=p("assessList");if(!e)return;Ua(),ci();const t=xt(us());if(!i.checklist.length){e.innerHTML='<p class="detail-empty">체크리스트를 불러오는 중...</p>',gs(0,0),Ye([],new Set);return}const s=lt(),n=new Set(s.map(r=>r.id));if(gs(s.length,us().length),!s.length){e.innerHTML='<p class="detail-empty">조건에 맞는 통제가 없습니다. 영역/상태 필터 또는 검색어를 바꿔 보세요.</p>',Ye(t,n);return}const a=xt(s);!i.categoriesBootstrapped&&t.length&&(i.collapsedCategories=new Set(t.slice(1).map(r=>r.categoryId)),i.activeCategoryId=t[0].categoryId,i.categoriesBootstrapped=!0),Ye(t,n),e.innerHTML=a.map((r,o)=>{const l=nt(r.controls),d=i.collapsedCategories.has(r.categoryId);return`
    ...
    `}).join(""),e.querySelectorAll("[data-toggle-category]").forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.toggleCategory,l=r.closest(".assess-category-group"),d=!i.collapsedCategories.has(o);d?i.collapsedCategories.add(o):i.collapsedCategories.delete(o),i.activeCategoryId=o,l&&l.classList.toggle("collapsed",d),r.setAttribute("aria-expanded",d?"false":"true"),document.querySelectorAll("#assessCategoryNav [data-jump-category]").forEach(u=>{u.classList.toggle("active",u.dataset.jumpCategory===o)})})}),e.querySelectorAll(".assess-row-head").forEach(r=>{r.addEventListener("click",o=>{if(o.target.closest("label.audit-check, input[type=checkbox], .domain-check-item, .assess-confidence, select[data-row-confidence]"))return;const d=r.closest(".assess-row").dataset.control,u=!i.expandedRows.has(d);u?i.expandedRows.add(d):i.expandedRows.delete(d),Ee(),u&&at(d)})}),e.querySelectorAll("[data-legal-basis]").forEach(r=>{at(r.dataset.legalBasis)}),e.querySelectorAll("[data-row-confidence]").forEach(r=>{r.addEventListener("click",o=>o.stopPropagation()),r.addEventListener("change",o=>{o.stopPropagation();const l=r.getAttribute("data-row-confidence");l&&(i.inputConfidence[l]=r.value,ge(),$(`${l} 신뢰도를 ${Yn[r.value]||r.value}로 저장했습니다.`),i.analysis&&G.renderConfirmationActions(i.analysis))})}),e.querySelectorAll("[data-check-control]").forEach(r=>{r.addEventListener("click",o=>{o.stopPropagation()}),r.addEventListener("change",o=>{o.stopPropagation(),hn(r.dataset.checkControl,r.dataset.checkKey,r.checked)})}),e.querySelectorAll("[data-domain-control]").forEach(r=>{r.addEventListener("click",o=>o.stopPropagation()),r.addEventListener("change",o=>{o.stopPropagation(),mn(r.dataset.domainControl,r.dataset.domainItem,r.checked)})})}async function ui(e=null){const t=e||await Se("/controls/checklist");i.checklist=t.controls;const s=JSON.stringify([i.assessments,i.controlChecks]);i.checklist.forEach(n=>{n.id in i.assessments||(i.assessments[n.id]="unknown"),W(n.id)}),s!==JSON.stringify([i.assessments,i.controlChecks])&&ge(),Kt(),Ee()}function pi(e,t){let s=t==="evidenced"?"done":t,n=!1;s==="done"&&!Y(e)&&(s="partial",n=!0),i.pendingDoneEvidenceControlId=null,Ce(e,_t(s)),s==="done"&&Ce(e,{...W(e),evidence:!0}),s==="unknown"?i.inputConfidence[e]="unknown":i.inputConfidence[e]="confirmed",i.sessionSelectedControlId=e,ge(),$(n?"증적 없이 부분 이행으로 저장했습니다.":`${e} 진단: ${_[s]||s}`),i.analysis&&(G.renderConfirmationActions(i.analysis),G.renderStats(),G.markAnalysisStale?.())}function bn(){const e=p("reportReturnBar");if(!e)return;const t=i.reportReturn;if(e.hidden=!t,!t)return;const s=p("reportReturnTitle"),n=p("reportReturnStatus");if(s){const a=[t.controlId,t.controlTitle].filter(Boolean).join(" ");s.textContent=[t.itemTitle,a].filter(Boolean).join(" · ")}n&&(n.textContent=i.analysisStale?"진단이 변경되었습니다. 돌아간 뒤 확인 목록을 갱신하세요.":"이 통제를 점검한 뒤 원래 카드로 돌아갈 수 있습니다.")}function fi(e){const t=(e?document.querySelector(`.session-detail-card[data-today-control="${CSS.escape(e)}"]`):null)||document.querySelector(".session-detail-card")||p("sessionDetailPane");if(!t||((t.querySelector(".today-card-top")||t.querySelector(".today-question")||t).scrollIntoView({behavior:"smooth",block:"start"}),!e))return;const n=p("sessionMasterTree"),a=n?.querySelector(`[data-select-control="${CSS.escape(e)}"]`);if(a&&n){const r=a.offsetTop,o=r+a.offsetHeight,l=n.scrollTop,d=l+n.clientHeight;(r<l||o>d)&&(n.scrollTop=Math.max(0,r-n.clientHeight/3))}}async function wn(e){if(e){if(i.analysis&&i.organizationProfile){i.sessionSelectedControlId=e,G.switchView?.("analyze"),G.switchAnalyzeSection?.("actions");const t=p("analyzeContent");t&&(t.style.display=""),G.renderConfirmationActions?.(i.analysis),bn(),window.requestAnimationFrame(()=>{window.setTimeout(()=>fi(e),80)});return}le("assessment"),$("먼저 점검 범위를 적용하고 진단을 시작하세요.")}}function dt(){return{headcountBand:p("profileHeadcount")?.value||Pe.headcountBand,industry:p("profileIndustry")?.value||Pe.industry,piiVolume:p("profilePiiVolume")?.value||Pe.piiVolume,usesCloud:!!p("profileCloud")?.checked,hasOnPremFacility:!!p("profileOnPrem")?.checked,usesOutsourcing:!1,usesRemoteAccess:!1,processesRrn:!1}}function it(e=dt()){return!!(e?.usesCloud||e?.hasOnPremFacility)}function gi(e){const t={...Pe,...e||{}};p("profileHeadcount")&&(p("profileHeadcount").value=t.headcountBand||"1-50"),p("profileIndustry")&&(p("profileIndustry").value=t.industry||"technology"),p("profilePiiVolume")&&(p("profilePiiVolume").value=t.piiVolume||"low"),p("profileCloud")&&(p("profileCloud").checked=!!t.usesCloud),p("profileOnPrem")&&(p("profileOnPrem").checked=!!t.hasOnPremFacility)}function $n(e){const t=e||dt();return t.usesCloud&&!t.hasOnPremFacility?["바뀌는 결과: 물리/전산실 통제 6개(2.4.1~2.4.6)만 N/A.","나머지 통제는 그대로 점검 대상입니다."]:t.usesCloud&&t.hasOnPremFacility?["바뀌는 결과: 물리 통제도 점검 대상(N/A 없음).","클라우드·전산실을 함께 운영하는 범위로 둡니다."]:!t.usesCloud&&t.hasOnPremFacility?["바뀌는 결과: 자체 전산실 기준으로 물리 통제를 점검.","N/A 규칙은 적용되지 않습니다."]:["운영 환경을 아직 고르지 않았습니다.","클라우드 또는 자체 인프라를 하나 이상 선택하세요."]}function Sn(){const e=p("profileImpact");if(!e)return;const t=dt(),s=it(t),n=i.checklist?.length||101,a=s&&t.usesCloud&&!t.hasOnPremFacility?6:0,r=$n(t).map(o=>`<li>${c(o)}</li>`).join("");e.classList.toggle("is-incomplete",!s),e.innerHTML=s?`
    ...
    <ul>${r}</ul>`,mi(s)}function mi(e=it()){const t=p("applyProfileBtn");t&&(t.disabled=!e)}function Be(){const e=p("view-assess");if(!e)return;const t=!!i.organizationProfile;e.classList.toggle("is-prestart",!t),e.classList.toggle("is-ready",t)}function Pt({focus:e=!0}={}){const t=p("profileInline");t&&(t.classList.add("open"),gi(i.organizationProfile),p("profileForm").style.display="",p("profileLede").style.display="",p("profileTitle").textContent=i.organizationProfile?"진단 환경 수정":"현재 운영 환경을 선택하세요",Sn(),e&&(t.scrollIntoView({behavior:"smooth",block:"start"}),window.setTimeout(()=>p("profileCloud")?.focus(),0)),Be())}function kn(){const e=p("profileInline");if(e){if(!i.organizationProfile){e.classList.add("open"),Be();return}e.classList.remove("open"),Be()}}function Jt(){const e=p("profileContextPanel");if(!e)return;if(!i.organizationProfile){e.innerHTML='<strong>아직 점검 범위 설정 전입니다.</strong><div class="profile-context-chips"><span>클라우드만 쓰면 물리 6개가 N/A가 됩니다.</span></div>';return}const t=i.organizationProfile,s=$n(t),n=[t.usesCloud&&!t.hasOnPremFacility?"물리 6개 N/A":null,t.usesCloud?"클라우드":null,t.hasOnPremFacility?"자체전산실":null,!t.usesCloud&&!t.hasOnPremFacility?"N/A 없음":null].filter(Boolean);e.innerHTML=`
  ...
  `}function vi(){const e=(i.checklist||[]).filter(s=>L(s.id)!=="na");return{reviewed:e.filter(s=>{const n=L(s.id);return n!=="unknown"&&n!=="na"}).length,applicable:e.length}}function Ge(){return(i.checklist||[]).filter(e=>L(e.id)!=="na")}function Cn(){return Ge().filter(e=>L(e.id)==="unknown")}function An(){return Ge().filter(e=>{const t=L(e.id);return t==="done"||t==="evidenced"})}function En(){const e=new Set(["unknown","none","partial"]);return Ge().filter(t=>e.has(L(t.id)))}function hi(e=[]){const t=new Set(e),s={unknown:0,none:1,partial:2};return En().filter(n=>!t.has(n.id)).sort((n,a)=>(s[L(n.id)]??9)-(s[L(a.id)]??9)||String(n.id).localeCompare(String(a.id)))}function Oe(){return xt(Ge())}function ms(e=null){const t=En().sort((a,r)=>ke(a.id,r.id));if(!t.length)return null;if(!e)return t[0].id;const s=t.findIndex(a=>a.id===e);return s>=0&&s+1<t.length?t[s+1].id:t.find(a=>ke(a.id,e)>0)?.id||t[0].id}function rt(){return Ge().slice().sort((e,t)=>ke(e.id,t.id)).map(e=>e.id)}function Mt(e,t=1){const s=rt();if(!s.length)return null;const n=s.indexOf(e);if(n<0)return t>0?s[0]:s[s.length-1];const a=n+t;return a<0||a>=s.length?null:s[a]}const vs={critical:"심각도 매우 높음",high:"심각도 높음",medium:"심각도 보통"},hs=[{min:80,key:"ready",label:"준비 완료",hint:"핵심 영역이 준비 완료 구간에 들어왔습니다."},{min:55,key:"rising",label:"안정화",hint:"핵심 영역이 안정화되고 있습니다. 남은 보완 항목을 이어서 확인하세요."},{min:25,key:"warming",label:"점검 중",hint:"진단이 진행 중입니다. 다음 통제를 점검하면 온도가 올라갑니다."},{min:0,key:"cold",label:"초기 단계",hint:"아직 점검 초반입니다. 미점검 통제부터 이어서 확인하세요."}];function yi(e={}){const t=Object.values(e).filter(Array.isArray);return{itemCount:t.reduce((s,n)=>s+n.length,0),controlCount:t.filter(s=>s.length>0).length}}function bi(e){return e==="done"||e==="evidenced"?1:e==="partial"?.5:0}function ae(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(100,Math.round(t))):0}function Ln({done:e=0,partial:t=0,applicable:s=0}={}){return s<=0?0:ae((Number(e)+Number(t)*.5)/s*100)}function wi({done:e=0,partial:t=0,none:s=0,applicable:n=0}={}){const a=Math.max(0,Number(e)+Number(t)+Number(s)),r=Math.max(0,Number(n)),o=r?ae(a/r*100):0,l=a?ae((Number(e)+Number(t)*.5)/a*100):null;return{reviewed:a,total:r,coverage:o,confirmedReadiness:l,confidence:o>=80?"high":o>=40?"medium":"low"}}function Yt(e){const t=ae(e);return hs.find(s=>t>=s.min)||hs.at(-1)}function $i(e=[],t=()=>"unknown"){const s=new Map;return e.forEach(n=>{const a=String(n.areaId||n.categoryId?.split(".")[0]||"0");s.has(a)||s.set(a,{areaId:a,label:J[a]||n.areaName||`영역 ${a}`,controls:[]}),s.get(a).controls.push(...n.controls||[])}),Array.from(s.values()).sort((n,a)=>String(n.areaId).localeCompare(String(a.areaId),"en",{numeric:!0})).map(n=>{const a=n.controls.length,r=n.controls.filter(f=>{const m=t(f.id);return m!=="unknown"&&m!=="na"}).length,o=n.controls.reduce((f,m)=>f+bi(t(m.id)),0),l=a?ae(o/a*100):0,d=r?ae(o/r*100):null,u=n.controls.find(f=>["unknown","none","partial"].includes(t(f.id)));return{areaId:n.areaId,label:n.label,temperature:l,confirmedReadiness:d,coverage:a?ae(r/a*100):0,band:Yt(l),reviewed:r,total:a,nextControlId:u?.id||""}})}function Si(e={}){const t=[];e.scenarioRelevant&&t.push("선택 시나리오 직접 관련"),e.level==="none"?t.push("미이행 우선"):e.level==="partial"&&t.push("부분 이행 보완 필요"),vs[e.severity]&&t.push(vs[e.severity]);const s=Array.isArray(e.profileRelevance)?e.profileRelevance[0]:"";return s&&t.push(`조직 조건 반영: ${s}`),t.slice(0,3)}function ki(e,t=null,s=[]){const n=t||s[0]||null;return e.levelFilter="weak",e.sessionSelectedControlId=n,n}function Ci({analysis:e,controlEvidence:t={},weakControlIds:s=[],stale:n=!1,groups:a=[],getLevel:r=()=>"unknown",nextControls:o=[],done:l=0,partial:d=0,applicable:u=0}={}){const f=yi(t),m=[...new Set(s.map(String))],g=m.filter(w=>Array.isArray(t[w])&&t[w].length>0).length,h=Math.max(m.length-g,0),b=Ln({done:l,partial:d,applicable:u}),A=wi({done:l,partial:d,none:m.filter(w=>r(w)==="none").length,applicable:u}),E=Yt(b),y=$i(a,r),x=[...y].sort((w,k)=>w.temperature-k.temperature)[0]||null,v=n?[]:(e?.topGaps||[]).slice(0,3).map((w,k)=>({rank:k+1,controlId:w.controlId||w.id||"",title:w.title||w.controlTitle||"우선 보완 통제",risk:w.riskIfMissing||"미흡 시 영향을 확인하고 보완 계획을 수립하세요.",selectionReasons:Si(w),mode:"gap"})),S=v.length?[]:o.slice(0,3).map((w,k)=>{const I=w.level||r(w.id)||"unknown";return{rank:k+1,controlId:w.id||w.controlId||"",title:w.title||"다음 점검 통제",risk:"이 통제를 진단하면 준비 온도가 올라갑니다.",selectionReasons:[_[I]||"미점검","다음 점검 대상"],mode:"queue",weak:I==="none"||I==="partial"}});return{stale:n,temperature:b,band:E,summary:A,areas:y,coolest:x,queueMode:!v.length,priorities:v.length?v:S,evidence:f,signals:[{label:"증적 미등록",value:h,suffix:"개",help:`보완 대상 ${m.length}개 중 ${g}개 통제에 증적이 등록되어 있습니다.`},{label:"등록 증적",value:f.itemCount,suffix:"건",help:f.itemCount?`${f.controlCount}개 통제에 증적이 연결되어 있습니다.`:"아직 등록된 증적이 없습니다. 판단 근거를 남기면 여기에 모입니다."}],categories:n?[]:(e?.gapClusters||[]).slice(0,4).map(w=>({label:w.theme||"미흡 통제 묶음",gapCount:Number(w.gapCount||0),controlId:String(w.controlIds?.[0]||w.primaryControl?.controlId||"")}))}}const Ai=[{id:"unknown",label:"미확인"},{id:"none",label:"미이행"},{id:"partial",label:"부분 이행"},{id:"done",label:"이행"}];function Ei({remaining:e=0,remediationCount:t=0}={}){return e>0?{title:"아직 진단하지 않은 통제가 있습니다.",help:"미점검 항목을 이어서 진단하면 준비 온도와 보완 대상이 더 정확해집니다.",actionAttr:"data-progress-next",actionLabel:"다음 미점검 통제",recCount:e,recLabel:"미점검 대상",recHelp:"우선순위가 높은 통제부터 현재 운영 상태를 확인하세요.",recItems:["미점검 통제 진단하기","판단 근거가 되는 증적 연결"]}:t>0?{title:"보완이 필요한 통제가 있습니다.",help:"부분 이행 항목을 중심으로 증적과 조치 상태를 우선 검토하세요.",actionAttr:"data-progress-weak",actionLabel:"우선 통제 검토",recCount:t,recLabel:"보완 대상",recHelp:"우선순위가 높은 통제부터 증적과 조치 상태를 확인하세요.",recItems:["부족한 증적 보완","개선 조치 계획 수립"]}:{title:"준비 상태가 안정권에 도달했습니다.",help:"적용 통제 진단을 모두 반영했습니다. 증적과 보고서를 이어서 확인하세요.",actionAttr:"",actionLabel:"",recCount:0,recLabel:"보완 대상 없음",recHelp:"등록한 증적과 보고서를 이어서 확인하세요.",recItems:["등록 증적 점검","진단 보고서 확인"]}}let ys=!1;function Li(){return i.levelFilter!=="all"||!!i.assessSearch.trim()||i.areaFilter!=="all"}function xn(e){const t=i.assessSearch.trim().toLowerCase();return e.map(s=>({...s,controls:s.controls.filter(n=>{if(i.areaFilter!=="all"&&String(n.areaId)!==String(i.areaFilter))return!1;const a=L(n.id);return i.levelFilter==="weak"&&!["none","partial"].includes(a)||!["all","weak"].includes(i.levelFilter)&&a!==i.levelFilter?!1:t?on(n,i.assessSearch):!0})})).map(s=>({...s,controls:ln(s.controls,i.assessSearch)})).filter(s=>s.controls.length)}function xi(){document.querySelectorAll("[data-session-level]").forEach(t=>{const s=t.getAttribute("data-session-level")===(i.levelFilter||"all");t.classList.toggle("is-active",s)});const e=p("sessionSearch");e&&e.value!==(i.assessSearch||"")&&(e.value=i.assessSearch||"")}function De(){if(!i.analysis)return;const e=F._hooks||{};Pn(i.analysis,{diagnoseControl:e.diagnoseControl,markAnalysisStale:e.markAnalysisStale})}function Ii(){if(ys)return;const e=p("sessionMasterTools");e&&(ys=!0,p("sessionSearch")?.addEventListener("input",t=>{i.assessSearch=t.target.value||"",De()}),e.querySelectorAll("[data-session-level]").forEach(t=>{t.addEventListener("click",()=>{const s=t.getAttribute("data-session-level")||"all";i.levelFilter=s,De()})}),e.querySelectorAll("[data-session-bulk-preset]").forEach(t=>{t.addEventListener("click",()=>{const s=t.getAttribute("data-session-bulk-preset");s&&(ri(s),De(),F._hooks?.markAnalysisStale?.())})}))}function Qt(e=[]){const t=new Map;return e.forEach(s=>{s?.controlId&&(s.slotId||String(s.actionId||"").startsWith("evidence-")||t.has(s.controlId)||t.set(s.controlId,s))}),t}function In(e=[]){return e.filter(t=>{if(!t?.controlId||t.slotId||String(t.actionId||"").startsWith("evidence-"))return!1;const s=L(t.controlId);return s!=="done"&&s!=="evidenced"&&s!=="na"}).slice(0,10).map(t=>t.controlId)}function Ti(e,t){const s=new Set(t.flatMap(n=>n.controls.map(a=>a.id)));return e&&s.has(e)?e:t[0]?.controls?.[0]?.id||null}function be(e){i.sessionSelectedControlId=e||null,Ue()}function Ri(e,t){i.sessionCollapsedCategories instanceof Set||(i.sessionCollapsedCategories=new Set),!i.sessionCollapsedCategories.size&&t.length&&t.forEach(n=>i.sessionCollapsedCategories.add(n.categoryId));const s=t.find(n=>n.controls.some(a=>a.id===e));s&&i.sessionCollapsedCategories.delete(s.categoryId)}function Pi(e){return e==="done"||e==="evidenced"?"done":e==="none"?"none":e==="partial"?"partial":"unknown"}function Mi(e,t,s){const n=p("sessionMasterTree"),a=p("sessionMasterCount");if(!n)return;const r=new Map;e.forEach(u=>{const f=String(u.areaId||u.categoryId?.split(".")[0]||"0");r.has(f)||r.set(f,{areaId:f,areaName:J[f]||u.areaName||`영역 ${f}`,groups:[]}),r.get(f).groups.push(u)});const o=Array.from(r.values()).sort((u,f)=>ke(u.areaId,f.areaId)),l=e.reduce((u,f)=>u+f.controls.length,0),d=Cn().length;a&&(a.textContent=Li()?`표시 ${l} · 미완료 ${d}`:`미완료 ${d}`),n.innerHTML=o.map(u=>{const f=u.groups.flatMap(g=>g.controls),m=nt(f);return`
      <div class="session-area-block">
        <div class="session-area-label">
          <span>${c(u.areaName)}</span>
          <span>${m.reviewed}/${m.total}</span>
        </div>
        ${u.groups.map(g=>{const h=i.sessionCollapsedCategories.has(g.categoryId),b=nt(g.controls);return`
            <div class="session-cat${h?" is-collapsed":""}" data-session-cat="${c(g.categoryId)}">
              ...
              <div class="session-cat-items">
                ${g.controls.map(A=>{const E=L(A.id),y=Pi(E),x=A.id===t?" is-selected":"",v=s.has(A.id)?" is-priority":"";return`
                    <button type="button" class="session-item tone-${y}${x}${v}" data-select-control="${c(A.id)}">
    ...
    `}).join("")||'<p class="detail-empty">표시할 통제가 없습니다.</p>',n.querySelectorAll("[data-toggle-session-cat]").forEach(u=>{u.addEventListener("click",()=>{const f=u.getAttribute("data-toggle-session-cat");i.sessionCollapsedCategories.has(f)?i.sessionCollapsedCategories.delete(f):i.sessionCollapsedCategories.add(f);const m=n.querySelector(`[data-session-cat="${f}"]`),g=i.sessionCollapsedCategories.has(f);m?.classList.toggle("is-collapsed",g),u.setAttribute("aria-expanded",g?"false":"true")})}),n.querySelectorAll("[data-select-control]").forEach(u=>{u.addEventListener("click",()=>{Tn(u.getAttribute("data-select-control"),{groups:e,prioritySet:s,scrollTree:!0,scrollDetail:!1})})})}function Tn(e,{groups:t,prioritySet:s,scrollTree:n=!1,scrollDetail:a=!1}={}){if(!e)return;const r=t||Oe(),o=Qt(i.analysis?.confirmationActions||[]),l=s||new Set(In(i.analysis?.confirmationActions||[]));i.pendingDoneEvidenceControlId&&i.pendingDoneEvidenceControlId!==e&&(i.pendingDoneEvidenceControlId=null),be(e);const d=r.find(f=>f.controls.some(m=>m.id===e));d&&i.sessionCollapsedCategories.delete(d.categoryId),F(e,o,l);const u=p("sessionMasterTree");if(u){if(u.querySelectorAll(".session-item").forEach(f=>{f.classList.toggle("is-selected",f.getAttribute("data-select-control")===e)}),u.querySelectorAll(".session-cat").forEach(f=>{const m=f.getAttribute("data-session-cat");f.classList.toggle("is-collapsed",i.sessionCollapsedCategories.has(m))}),n){const f=u.querySelector(`[data-select-control="${CSS.escape(e)}"]`);if(f){const m=u.getBoundingClientRect(),g=f.getBoundingClientRect();(g.top<m.top||g.bottom>m.bottom)&&(u.scrollTop+=g.top-m.top-u.clientHeight/3)}}a&&window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{Ni(e)})})}}function Ni(e){const t=(e?document.querySelector(`.session-detail-card[data-today-control="${CSS.escape(e)}"]`):null)||document.querySelector(".session-detail-card")||p("sessionDetailPane");if(!t)return;(t.querySelector(".today-card-top")||t.querySelector(".today-question")||t).scrollIntoView({behavior:"smooth",block:"start"})}function Rn(e){return i.analysis?.controlSessionDetails?.[e]||null}function bs(e){return(e||[]).map(t=>`<li>${c(t)}</li>`).join("")}function Di(e,t,s){const n=(i.checklist||[]).find(M=>M.id===e)||{},a=Rn(e),r=L(e),o=t?.title||a?.title||n.title||"",l=t?.question||a?.question||`${o||e} 이행 상태를 확인했나요?`,d=String(t?.whyItMatters||"").trim(),u=String(t?.actionGuide||a?.actionGuide||"").trim(),f=d.length>220?`${d.slice(0,217)}…`:d,m=u.length>180?`${u.slice(0,177)}…`:u,g=W(e),h=Object.keys(V).map(M=>`
    <label class="audit-check" title="${c(e)} ${qs[M]}">
      <input type="checkbox" data-check-control="${c(e)}" data-check-key="${M}"${g[M]?" checked":""}>
      <span>${V[M]}</span>
    </label>
  `).join(""),b=n.checklistItems||[],A=Vt(e,b),E=b.map((M,Kn)=>{const mt=String(Kn+1),Jn=!!A[mt];return`
      <li class="domain-check-item">
        <label>
          <input type="checkbox" data-domain-control="${c(e)}" data-domain-item="${mt}"${Jn?" checked":""}>
          <span><strong>${mt}.</strong> ${c(M)}</span>
        </label>
      </li>
    `}).join(""),y=zt(e),x=i.pendingDoneEvidenceControlId===e,v=r==="evidenced"?"done":r,S=x?"done":v,w=Ai.map(M=>`
  ...
  `).join(""),k=bs((n.officialEvidenceExamples||[]).slice(0,8)),I=bs(n.recommendedActions||[]),z=y.length?y.map(M=>`
      ...
      `).join(""):"",C=rt(),T=C.indexOf(e),B=Mt(e,-1),gt=Mt(e,1),We=T>=0?`${T+1} / ${C.length}`:"",O=We?`
  ...
  `:"",Q=(n.officialEvidenceExamples||[])[0]?`예: ${n.officialEvidenceExamples[0]}`:"예: 출입대장 캡처 / 공유폴더";return`
    <article class="today-card session-detail-card" data-today-control="${c(e)}">
      <div class="today-card-top">
        ...
        <span class="status-pill level-${v}">${c(_[v]||v)}</span>
      </div>
  ...
  `}function ws(e,{diagnoseControl:t,groups:s,prioritySet:n}={}){const a={...F._hooks||{},diagnoseControl:t||F._hooks?.diagnoseControl||(()=>{})},r=Qt(i.analysis?.confirmationActions||[]);F(e,r,n||new Set,a),window.requestAnimationFrame(()=>{p("sessionDetailPane")?.querySelector("[data-done-evidence-form] input[name='line']")?.focus()})}function qi(e,{diagnoseControl:t,groups:s,prioritySet:n}={}){e.querySelectorAll("[data-diagnose-control]").forEach(a=>{a.addEventListener("click",()=>{const r=a.getAttribute("data-diagnose-control"),o=a.getAttribute("data-diagnose-level");if(!(!r||!o||!t)){if(o==="done"&&!Y(r)){be(r),i.pendingDoneEvidenceControlId=r,ws(r,{diagnoseControl:t,groups:s,prioritySet:n});return}i.pendingDoneEvidenceControlId=null,t(r,o)}})}),e.querySelectorAll("[data-check-control]").forEach(a=>{a.addEventListener("change",()=>{const r=a.getAttribute("data-check-control"),o=a.getAttribute("data-check-key");!r||!o||(be(r),hn(r,o,!!a.checked))})}),e.querySelectorAll("[data-domain-control]").forEach(a=>{a.addEventListener("change",()=>{const r=a.getAttribute("data-domain-control"),o=a.getAttribute("data-domain-item");!r||!o||(mn(r,o,!!a.checked),i.analysis&&typeof F._hooks?.markAnalysisStale=="function"&&F._hooks.markAnalysisStale())})}),e.querySelectorAll("[data-session-nav]").forEach(a=>{a.addEventListener("click",()=>{const r=a.getAttribute("data-session-nav")==="prev"?-1:1,o=i.sessionSelectedControlId,l=Mt(o,r);l&&(i.pendingDoneEvidenceControlId=null,Tn(l,{groups:s||Oe(),prioritySet:n,scrollTree:!0,scrollDetail:!0}))})}),e.querySelectorAll("[data-done-evidence-form]").forEach(a=>{a.addEventListener("submit",r=>{r.preventDefault();const o=a.getAttribute("data-done-evidence-form");if(!o||!t)return;const l=String(new FormData(a).get("line")||"").trim();!l||(i.pendingDoneEvidenceControlId=null,!fs(o,{title:l},{quiet:!0}))||t(o,"done")})}),e.querySelectorAll("[data-evidence-register-form]").forEach(a=>{a.addEventListener("submit",r=>{r.preventDefault();const o=a.getAttribute("data-evidence-register-form"),l=String(new FormData(a).get("line")||"").trim();!o||!l||!fs(o,{title:l},{quiet:!0})||ws(o,{diagnoseControl:t,groups:s,prioritySet:n})})}),e.querySelectorAll("[data-done-evidence-skip]").forEach(a=>{a.addEventListener("click",()=>{const r=a.getAttribute("data-done-evidence-skip");!r||!t||(i.pendingDoneEvidenceControlId=null,t(r,"partial"))})}),e.querySelectorAll("[data-evidence-remove]").forEach(a=>{a.addEventListener("click",()=>{const r=a.getAttribute("data-evidence-remove"),o=a.getAttribute("data-evidence-id");!r||!o||ni(r,o)})})}function F(e,t,s,n){const a=p("sessionDetailPane");if(!a)return;if(!e){a.innerHTML='<p class="detail-empty">왼쪽 지도에서 통제를 선택하세요.</p>';return}const r=t.get(e)||null,o=(i.checklist||[]).find(m=>m.id===e)||{},l=r?.title||Rn(e)?.title||o.title||"",d=p("workspaceContextDetail"),u=p("view-analyze")?.classList.contains("is-assessment")||p("view-analyze")?.classList.contains("is-evidence");d&&u&&(d.textContent=`${e} · ${l}`),n&&(F._hooks=n);const f=n||F._hooks||{diagnoseControl:()=>{}};a.innerHTML=Di(e,r,s),qi(a,{...f,groups:xn(Oe()),prioritySet:s}),at(e)}function Pn(e,{diagnoseControl:t,markAnalysisStale:s}={}){const n={diagnoseControl:t||(()=>{}),markAnalysisStale:s};F._hooks=n,Ii(),xi();const{reviewed:a,applicable:r}=vi(),o=p("assessmentProgressStrip"),l=e?.confirmationActions||[],d=e?.confirmationActionMeta||{};d.mode&&(i.sessionBundleMode=d.mode);const u=Qt(l),f=In(l),m=new Set(f),g=Cn(),h=An().length,b=rt().reduce((C,T)=>{const B=L(T);return(B==="none"||B==="partial")&&(C[B]+=1),C},{none:0,partial:0}),A=xn(Oe()),E=Oe(),y=Ti(i.sessionSelectedControlId,A);i.sessionSelectedControlId=y,Ri(y,A);const x=Ci({analysis:e,controlEvidence:i.controlEvidence,weakControlIds:rt().filter(C=>["none","partial"].includes(L(C))),stale:i.analysisStale,groups:E,getLevel:L,nextControls:hi().map(C=>({id:C.id,title:C.title,level:L(C.id)})),done:h,partial:b.partial,applicable:r}),v=(C=null,{weak:T=!1}={})=>{T?(ki(i,C,f),be(i.sessionSelectedControlId)):(i.levelFilter="all",be(C||ms())),le("assessment"),De(),window.requestAnimationFrame(()=>{p("sessionMasterDetail")?.scrollIntoView({behavior:"smooth",block:"start"})})},S=(C=null)=>v(C,{weak:!0});if(o){const C=x.temperature,T=x.band,B=Q=>r>0?`${(Q/r*100).toFixed(1)}%`:"0%",gt=g.length,We=b.none+b.partial,O=Ei({remaining:gt,remediationCount:We});o.classList.add("is-complete"),o.classList.remove("is-cold","is-warming","is-rising","is-ready"),o.classList.add(`is-${T.key}`),o.innerHTML=`
    ...
    `,o.querySelector("[data-progress-next]")?.addEventListener("click",()=>{i.levelFilter="unknown",be(ms()),De(),p("sessionMasterDetail")?.scrollIntoView({behavior:"smooth",block:"start"})}),o.querySelectorAll("[data-progress-weak]").forEach(Q=>Q.addEventListener("click",()=>{S()}))}const w=p("confirmationActionCount");w&&(w.textContent=`진행 ${a}/${r}`),Mi(A,y,m),F(y,u,m,n);const k=e?.applicabilityNotes||[],I=p("applicabilityNotesPanel"),z=p("applicabilityNotesList");I&&z&&(k.length?(I.style.display="",z.innerHTML=`<ul>${k.map(C=>`<li><strong>${c(C.controlId)}</strong> — ${c(C.reason||"")}</li>`).join("")}</ul>`):I.style.display="none")}function $s(e,t,s,n=[]){e&&(e.style.display="",e.classList.toggle("is-empty",!!s),t&&(t.style.display=s?"":"none"),n.forEach(a=>{a&&(a.style.display=s?"none":"")}))}const Ss={cluster:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="4" width="8" height="7" rx="1.6"/><rect x="13" y="4" width="8" height="7" rx="1.6"/><rect x="8" y="13" width="8" height="7" rx="1.6"/></svg>',link:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="7" cy="12" r="3"/><circle cx="17" cy="12" r="3"/><path d="M10 12h4"/></svg>',ready:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M8 12.4 10.7 15.2 16.2 9"/></svg>'};function Mn(e={}){const t=e.statusCounts||{},s=Number(t.unknown||0),n=Number(t.none||0),a=Number(t.partial||0),r=Number(t.done||0)+Number(t.evidenced||0),o=Number(t.na||0),l=Number(e.applicableControlCount||0),d=Number(e.reviewedControlCount||n+a+r);return{unknown:s,none:n,partial:a,done:r,na:o,applicable:l,reviewed:d,weak:n+a,complete:l>0&&d>=l}}function Nn(e={}){return[{key:"none",label:"미이행",value:e.none||0},{key:"partial",label:"부분 이행",value:e.partial||0},{key:"unknown",label:"미점검",value:e.unknown||0},{key:"done",label:"이행",value:e.done||0}]}function Bi(e=[]){return e.length?`<p class="result-empty-meta">${e.map(t=>`<span class="level-${c(t.key||"")}">${c(t.label||"")} <b>${Number(t.value||0)}</b></span>`).join("")}</p>`:""}function we({tone:e="idle",icon:t="cluster",title:s="",body:n="",stats:a=[],ctaLabel:r="자가진단 이어가기",ctaHref:o=`${H}/assessment`,ctaRoute:l="assessment"}={}){return`
    <article class="result-empty tone-${c(e)}" role="status">
      <div class="result-empty-icon" aria-hidden="true">${Ss[t]||Ss.cluster}</div>
  ...
  `}function Oi(e={}){const t=Mn(e),s=Nn(t);return t.complete&&t.weak===0?we({tone:"ready",icon:"ready",title:"점검한 통제에서 묶을 미흡이 없습니다",body:"미이행·부분 이행이 없어 중분류 보완 묶음을 표시하지 않습니다.",stats:s,ctaLabel:"보고서 보기",ctaHref:`${H}/report`,ctaRoute:"report"}):t.weak>0?we({tone:"wait",icon:"cluster",title:"같은 중분류에서 함께 보완할 항목이 없습니다",body:`미흡 ${t.weak}개는 확인됐지만, 한 중분류에 2개 이상 모여야 카드가 생깁니다.`,stats:s}):we({tone:"idle",icon:"cluster",title:"아직 묶을 미흡 통제가 없습니다",body:"같은 중분류에 미이행·부분 이행이 2개 이상일 때 여기에 표시됩니다.",stats:s})}function ji(e={}){const t=Mn(e),s=Nn(t);return t.complete&&t.weak===0?we({tone:"ready",icon:"ready",title:"연계할 미흡 통제가 없습니다",body:"미이행·부분 이행이 없어 영향 경로를 띄울 출발점이 없습니다.",stats:s,ctaLabel:"보고서 보기",ctaHref:`${H}/report`,ctaRoute:"report"}):t.weak>0?we({tone:"wait",icon:"link",title:"확인된 미흡 통제 기준의 연계 경로가 없습니다",body:`미흡 ${t.weak}개는 확인됐지만, 다른 통제로 이어지는 경로는 식별되지 않았습니다.`,stats:s}):we({tone:"idle",icon:"link",title:"아직 식별된 연계 문제가 없습니다",body:"미흡으로 확인된 통제가 생기면 영향 경로가 여기에 표시됩니다.",stats:s})}function Qe(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(100,t)):0}function ks(e){const t=Qe(e);return Number.isInteger(t)?String(t):t.toFixed(1)}function $e(e){if(e==null||e==="")return"판단 보류";const t=Number(e);return Number.isFinite(t)?t>=80?"양호":t>=60?"보통":t>=35?"보완 필요":"기초 보완 필요":"판단 보류"}function Hi(e){const t=["전체 진행 참고","전체 진행 반영 점수","점검분 이행 참고","점검분만 이행 점수","내부 참고점수","내부 참고 점수","평가분 이행점수","평가분 이행 점수"];let s=e;for(const n of t){const a=n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");s=s.replace(new RegExp(`${a}\\s*([\\d.]+)\\s*%`,"g"),(r,o)=>`${n.includes("점검")||n.includes("평가분")?"점검분 이행 참고":"전체 진행 참고"} '${$e(o)}'`)}return s=s.replace(/(^|\n)(- [^:\n]+):\s*([\d.]+)%/g,(n,a,r,o)=>`${a}${r}: ${$e(o)}`),s=s.replace(/준비도\s*([\d.]+)%/g,(n,a)=>`참고 구간 '${$e(a)}'`),s}function D(e){const t=String(e??"").replaceAll("내부 참고점수(진행 반영)","전체 진행 참고").replaceAll("내부 참고 점수(진행 반영)","전체 진행 참고").replaceAll("전체 진행 반영 점수","전체 진행 참고").replaceAll("내부 참고점수","전체 진행 참고").replaceAll("내부 참고 점수","전체 진행 참고").replaceAll("점검분만 이행 점수","점검분 이행 참고").replaceAll("평가분 이행점수","점검분 이행 참고").replaceAll("평가분 이행 점수","점검분 이행 참고").replaceAll("점수 가중치:","참고 구간:").replaceAll("상태별 배점:","참고 구간:").replaceAll("미이행 5 · 부분 이행 45 · 이행 80 · 증적 확보 100","양호 · 보통 · 보완 필요 · 기초 보완 필요").replaceAll("미이행 5 · 부분 이행 45 · 이행 80","양호 · 보통 · 보완 필요 · 기초 보완 필요").replaceAll("미이행 0 · 부분 이행 50 · 이행 100","양호 · 보통 · 보완 필요 · 기초 보완 필요").replaceAll("미이행 0 · 부분 이행 45 · 이행 80","양호 · 보통 · 보완 필요 · 기초 보완 필요").replaceAll("미이행 5 · 부분 이행 45","양호 · 보통 · 보완 필요 · 기초 보완 필요").replaceAll("부분 이행 45 · 이행 80","양호 · 보통 · 보완 필요 · 기초 보완 필요").replaceAll("미이행 5 · 양호","양호").replaceAll("미이행 5 · ","").replaceAll("미이행 5 ·","").replaceAll("미이행 5","").replaceAll(" · 증적 확보 100","").replaceAll("· 증적 확보 100","").replaceAll(" · 이행 80","").replaceAll("· 이행 80","");return Hi(t)}function Cs(e,t="관련 리스크를 확인하세요."){const s=String(e||"").replace(/\s+/g," ").trim();return s?s.length>110?`${s.slice(0,108)}…`:s:t}function Fi(e,t="unknown"){const s=L(e);return s||t||"unknown"}function zi(e,t){const s=e||"unknown",n=t||_[s]||s;return`<span class="level-badge level-${c(s)}">${c(n)}</span>`}function _i(e){return(i.checklist.find(s=>s.id===e)||i.allControls.find(s=>s.id===e))?.title||""}const $t=5;let X=1,Z=null;function Xt(e,t,s=!1){e&&(e.value=String(t||""),e.dataset.userEdited=s?"1":"0",e.dispatchEvent(new CustomEvent("report-editor:set",{detail:{value:e.value,edited:s}})))}function je(){const e=i.lastAiExecutiveReport||i.analysis?.executiveReport||"";return D(e)}function Nt(){return!!String(i.lastAiExecutiveReport||i.analysis?.executiveReport||"").trim()}function Zt(){return p("executiveReportStream")?.dataset.userEdited==="1"?"edited":i.lastAiExecutiveReport?"ai":i.analysis?.executiveReport?"rule":"empty"}function ce(e,t=!1){const s=p("reportEditorState");s&&(s.textContent=e,s.classList.toggle("is-dirty",t),s.classList.toggle("is-ai",!t&&Zt()==="ai"))}function qe(){const e=p("reportWordCount"),t=p("executiveReportStream");if(!e||!t||t.dataset.reactEditor==="1")return;const s=String(t.value||"").length;e.textContent=`공백 포함 ${s.toLocaleString("ko-KR")}자`}function Ui(){const e=p("reportComposeOverlay"),t=p("reportPage"),s=p("executiveReportStream");if(!e)return;const n=e.querySelector('[data-overlay-state="empty"]'),a=e.querySelector('[data-overlay-state="writing"]'),r=!!i.aiReportWriting,o=!Nt()&&!r;e.hidden=!(r||o),n&&(n.hidden=!o),a&&(a.hidden=!r),t?.classList.toggle("is-writing",r),t?.setAttribute("aria-busy",r?"true":"false"),s&&(s.readOnly=r)}function es(){const e=Zt(),t=!!i.aiReportWriting,s={basis:!!i.analysis||t,draft:e==="ai"||e==="edited"||t,edit:e==="edited"||e==="ai"&&!t,export:e==="ai"||e==="edited"||e==="rule"},n=t?"draft":e==="edited"||e==="ai"?"edit":e==="rule"?"draft":"basis";document.querySelectorAll("[data-report-flow]").forEach(a=>{const r=a.getAttribute("data-report-flow");a.classList.toggle("is-done",!!s[r]&&r!==n),a.classList.toggle("is-active",r===n)})}function Gi(){const e=p("executiveReportStream");!e||e.dataset.editorBound==="1"||(e.dataset.editorBound="1",e.addEventListener("input",()=>{e.dataset.userEdited="1",ce("편집 중",!0),qe(),es();const t=p("reportSourceBadge");t&&(t.textContent="직접 편집"),window.clearTimeout(Number(e.dataset.saveTimer||0));const s=window.setTimeout(()=>{e.dataset.savedValue=e.value,ce("편집 내용 유지됨",!1)},450);e.dataset.saveTimer=String(s)}),e.addEventListener("compositionend",qe),e.addEventListener("change",qe),window.addEventListener("report-editor:toast",t=>$(t.detail||"보고서 편집 내용을 확인하세요.")),j())}function Wi(e,t="편집 내용 유지됨"){e.dataset.userEdited="1",e.dataset.savedValue=e.value,ce(t,!1),qe(),es();const s=p("reportSourceBadge");s&&(s.textContent="직접 편집")}function te(){Z=null;const e=p("reportRewritePreview");e&&(e.hidden=!0)}function Vi(){const e=p("executiveReportStream"),t=p("reportRewriteBtn"),s=p("reportRewriteAcceptBtn"),n=p("reportRewriteRejectBtn"),a=p("reportRewriteCloseBtn");!e||!t||t.dataset.bound==="1"||(t.dataset.bound="1",t.addEventListener("click",async()=>{if(!await Ws())return;const r=e.selectionStart,o=e.selectionEnd,l=e.value.slice(r,o).trim();if(!l){$("보고서 본문에서 개선할 문장을 먼저 선택하세요."),e.focus();return}if(l.length>8e3){$("선택 문장은 8,000자 이하로 줄여주세요.");return}t.disabled=!0,t.textContent="개선 중…",te();try{const d=await fetch("/controls/report/rewrite",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:l,mode:p("reportRewriteMode")?.value||"professional"})});if(!d.ok){const f=await d.json().catch(()=>({}));throw new Error(f.detail||"문장 개선 요청에 실패했습니다.")}const u=await d.json();Z={start:r,end:o,original:e.value.slice(r,o),suggestion:String(u.suggestion||"")},p("reportRewriteBefore").textContent=Z.original,p("reportRewriteAfter").textContent=Z.suggestion,p("reportRewriteStatus").textContent=u.reason||"개선안을 확인하세요.",p("reportRewritePreview").hidden=!1,s.disabled=!u.applied||Z.suggestion===Z.original,a?.focus()}catch(d){$(`문장 개선 실패: ${d.message}`)}finally{t.disabled=!1,t.textContent="선택 문장 개선"}}),s?.addEventListener("click",()=>{if(!Z)return;const{start:r,end:o,original:l,suggestion:d}=Z;if(e.value.slice(r,o)!==l){$("본문이 변경되어 개선안을 적용할 수 없습니다. 문장을 다시 선택하세요."),te();return}e.value=`${e.value.slice(0,r)}${d}${e.value.slice(o)}`,e.setSelectionRange(r,r+d.length),Wi(e,"개선안 적용됨"),te(),e.focus(),$("선택 문장에 개선안을 적용했습니다.")}),n?.addEventListener("click",()=>{te(),$("개선안을 적용하지 않았습니다.")}),a?.addEventListener("click",te),document.addEventListener("keydown",r=>{r.key==="Escape"&&!p("reportRewritePreview")?.hidden&&(te(),e.focus())}))}function Ki(){const e=p("executiveReportStream");e&&(Xt(e,je()||"확인 목록을 갱신하면 초안이 여기에 표시됩니다."),e.dataset.sourceValue=e.value,e.dataset.userEdited="0",te(),ce("원문 복원됨",!1),j(),$("자동 생성 원문으로 복원했습니다."))}function Ji(){if(i.activeSessionId)return i.analysisHistory||[];try{return JSON.parse(localStorage.getItem(tt)||"[]")}catch{return[]}}function j(){const e=!!i.lastAiExecutiveReport,t=!!i.aiReportWriting,s=!!i.analysis&&!i.analysisStale&&!t,n=Zt(),a={empty:"초안 없음",rule:"진단 초안",ai:"AI 초안",edited:"직접 편집"},r=p("reportSourceBadge");r&&(r.textContent=t?"작성 중":a[n]),document.querySelectorAll("[data-write-ai-report]").forEach(u=>{u.disabled=!s,u.id==="writeAiReportBtn"&&(u.textContent=t?"작성 중…":e?"AI로 다시 작성":Nt()?"AI로 재작성":"AI로 초안 작성",u.classList.toggle("primary",!e||t))});const o=p("exportReportDocxBtn");o&&o.classList.toggle("primary",e&&!t);const l=p("resetReportBtn");l&&(l.disabled=t||!Nt()),Ui(),es(),qe();const d=p("aiReportStatus");if(d){if(d.classList.remove("is-ready","is-pending"),t){d.hidden=!0;return}if(i.analysisStale){d.hidden=!1,d.classList.add("is-pending"),d.textContent="진단이 바뀌었습니다. 확인 목록을 먼저 갱신하세요.";return}if(e&&i.aiReportStale){d.hidden=!1,d.classList.add("is-pending"),d.textContent="확인 목록이 바뀌었습니다. 아래는 이전 AI 문장입니다.";return}if(e){d.hidden=!1,d.classList.add("is-ready"),d.textContent="AI 초안입니다. 본문을 직접 고친 뒤 Word로 내보내세요.";return}if(n==="rule"){d.hidden=!1,d.classList.add("is-pending"),d.textContent="지금은 진단 기반 초안입니다. AI로 문장을 재작성할 수 있습니다.";return}d.hidden=!0}}function He(e={}){const t=p("executiveReportStream");if(!t)return;const s=p("reportEditorBasis");if(s&&(s.textContent=`현재 진단 ${Number(i.analysis?.reviewedControlCount)||0}/${Number(i.analysis?.applicableControlCount)||0} 기준`),t.classList.contains("typing")||i.aiReportWriting)return;const n=!!e.preferTemplate;if(t.dataset.userEdited==="1"&&!n)return;const a=n?D(i.analysis?.executiveReport||je()):je();t.dataset.historyKey=i.activeSessionId||"default",Xt(t,a),t.dataset.sourceValue=a,t.dataset.userEdited="0",ce(a?"초안 준비됨":"초안 대기",!1),j()}async function Yi(e){const t=p("executiveReportStream");if(!t)return;const s=i.reportStreamToken=(i.reportStreamToken||0)+1,n=D(e);if(t.dataset.reactEditor==="1"){Xt(t,n),t.dataset.sourceValue=n,ce("AI 초안 적용됨",!1),j();return}t.value="",t.dataset.userEdited="0",t.classList.add("typing");const a=3;for(let r=0;r<n.length;r+=a){if(s!==i.reportStreamToken)return;t.value+=n.slice(r,r+a),t.scrollTop=t.scrollHeight,await sa(14)}s===i.reportStreamToken&&(t.classList.remove("typing"),t.dataset.sourceValue=n,ce("AI 초안 적용됨",!1),j())}function Dn(e){const t={ts:Number(e.clientAnalyzedAt||Date.now()),overallReadiness:e.overallReadiness,gapCount:e.gapCount,readinessLabel:e.readinessLabel,scenarioId:i.analyzeScenarioId||null};if(X=1,i.activeSessionId){i.analysisHistory=[t,...i.analysisHistory||[]].slice(0,8),Ue();return}try{const s=JSON.parse(localStorage.getItem(tt)||"[]");s.unshift(t),localStorage.setItem(tt,JSON.stringify(s.slice(0,8)))}catch{}}function Qi(e){const t=new Date(e.ts).toLocaleString("ko-KR"),s=c(e.readinessLabel||(Number.isFinite(Number(e.overallReadiness))?$e(e.overallReadiness):"—")),n=Number.isFinite(Number(e.gapCount))?e.gapCount:0;return`
  ...
  `}function ts(){const e=p("analysisHistory"),t=p("analysisHistoryMeta");if(e)try{const s=Ji();if(t&&(t.textContent=s.length?`${s.length}건`:"기록 없음"),!s.length){X=1,e.innerHTML=`
...
`);function ss(e){const t=String(e||"");return t.includes("내부 참고")||t.includes("전체 진행 반영")||t==="전체 진행 참고"||t==="전체 진행 반영 점수"?"전체 진행 참고":t.includes("평가분")||t.includes("점검분만")||t.includes("점검분 이행")||t==="점검분 이행 참고"||t==="점검분만 이행 점수"?"점검분 이행 참고":D(t)}function qn(e,t){const s=String(e?.label||""),n=ss(s);return n==="전체 진행 참고"||s.includes("내부 참고")||s.includes("전체 진행")?D(String(t?.overallScoreTooltip||ar).trim()):n==="점검분 이행 참고"||s.includes("평가분")||s.includes("점검분")?D(String(t?.assessedScoreTooltip||ir).trim()):D(String(e?.tooltip||"").trim())}function Bn(e={},t=null){const s=t||ie?.analysis||i.analysis,n=new Set(["전체 진행 참고","점검분 이행 참고"]),a=Array.isArray(e.stats)?e.stats.map(u=>{const f=ss(u?.label);let m=u?.value;if(n.has(f)){const g=String(m??""),h=g.match(/([\d.]+)\s*%/);m=h?$e(h[1]):D(g)}return{...u,label:f,value:m,tooltip:qn({...u,label:f},s)}}):e.stats,r=Array.isArray(e.basis)?e.basis.map(u=>D(u)):e.basis;let o=e.metric,l=e.metricUnit;const d=D(e.metricLabel);if(d==="점검분 이행 참고"||d==="전체 진행 참고"||String(e.metricUnit||"")==="%"){const u=Number(o);Number.isFinite(u)&&(d.includes("참고")||d.includes("점수"))&&(o=$e(u),l="")}return{...e,title:D(e.title),headline:D(e.headline),explanation:D(e.explanation),question:D(e.question),metricLabel:d,metric:o,metricUnit:l,body:D(e.body),nextAction:D(e.nextAction),stats:a,basis:r}}function As(e=[]){if(!e.length)return"";const t=ie?.analysis||i.analysis;return`
  ...
  `:""}function On(e,t={}){const s=String(e||"").trim(),n=(i.checklist||[]).find(m=>m.id===s)||(i.allControls||[]).find(m=>m.id===s),a=(i.analysis?.topGaps||i.analysis?.criticalGaps||[]).find(m=>m.controlId===s),r=Fi(s,t.level||a?.level||"unknown"),o=String(t.title||n?.title||a?.title||_i(s)||"").trim(),l=o&&o!==s?o:o||s,d=String(n?.areaName||t.areaName||a?.areaName||J[s.split(".")[0]]||"").trim(),u=String(n?.categoryName||t.categoryName||a?.categoryName||"").trim(),f=String(t.tip||a?.detailNarrativeTip||a?.organicAnalysis||a?.problem||"").replace(/\s+/g," ").trim();return{controlId:s,title:l,role:String(t.role||"").trim(),areaName:d,categoryName:u,tip:f.length>96?`${f.slice(0,94)}…`:f,level:r,levelLabel:_[r]||t.levelLabel||a?.levelLabel||r}}function jn(e={}){const t=[],s=new Set,n=a=>{const r=String(a?.controlId||a||"").trim();!r||s.has(r)||(s.add(r),t.push(On(r,typeof a=="object"?a:{})))};return[...e.controlNodes||[],...e.pathNodes||[]].forEach(n),(e.chips||[]).forEach(a=>n({controlId:a})),!t.length&&e.action?.controlId&&n({controlId:e.action.controlId}),t}function lr(e=[]){return e.length?`
  ...
  `:'<p class="detail-empty">연결할 통제가 없습니다.</p>'}function cr(e=[]){return e.length?`
    <div class="report-review-control-list" aria-label="관련 통제 목록">
      ${e.map(t=>{const s=On(t.controlId,t);return`
  ...
  `,{step:e.querySelector("[data-review-step]"),label:e.querySelector("[data-review-label]"),track:e.querySelector("[data-review-track-fill]"),host:e.querySelector("[data-review-card-host]")})}function br(e,t,s){const n=jn(e);return`
  ...
  `}function re(e){const t=p("reportReviewQueue");if(!t)return;vr(t);const s=pr(e);if(!s.length){t.dataset.shell="empty",ie=null,t.innerHTML=hr(e);return}const n=fr(e,s),a=Hn(n),r=new Set(a.confirmed),o=new Set(a.ignored),l=s.filter(b=>!r.has(b.id)&&!o.has(b.id)),d=s.length-l.length,u=l[0],f=s.length?Math.round(d/s.length*100):0,m=Math.min(d+1,s.length);if(!u){t.dataset.shell="complete",ie={analysis:e,fingerprint:n,current:a,active:null},t.innerHTML=`
      <div class="report-review-progress" aria-label="확인 목록 검토 진행">
        <div class="report-review-progress-meta">
    ...
    `;return}const g=Bn(u.card||nr(u.text),e);ie={analysis:e,fingerprint:n,current:a,active:{...u,card:g}};const h=yr(t);if(h.step&&(h.step.innerHTML=`완료 ${d}<em> / ${s.length}</em>`),h.label&&(h.label.textContent=`지금 ${m}번째 · 완료율 ${f}%`),h.track){const b=h.track.parentElement;b&&b.setAttribute("aria-valuenow",String(f)),h.track.style.width=`${f}%`}if(h.host){const b=!!h.host.querySelector("[data-review-related-panel]:not([hidden])");if(h.host.innerHTML=br(g,u,l.length),b){const A=h.host.querySelector("[data-review-related-panel]"),E=h.host.querySelector("[data-review-related-toggle]");A&&(A.hidden=!1),E&&(E.setAttribute("aria-expanded","true"),E.textContent="관련 통제 접기")}}}let me=null,Xe=null,ve=null,Ze=null;function Fn(e){return{assessments:i.assessments,scenarioId:i.analyzeScenarioId||null,sessionBundleMode:i.sessionBundleMode||"chain",controlChecks:i.controlChecks,domainChecks:e(),questChecks:i.questChecks||{},inputConfidence:i.inputConfidence||{},organizationProfile:i.organizationProfile,view:"full"}}function wr(e,t={},s){if(me)return $("확인 목록을 이미 갱신하고 있습니다."),me;Xe=new AbortController;const a=kr(e,t,s,Xe.signal).finally(()=>{me===a&&(me=null,Xe=null)});return me=a,me}function zn(){Xe?.abort(),Ze?.abort(),i.reportStreamToken=(i.reportStreamToken||0)+1,i.aiReportWriting=!1,j()}function $r(e={}){if(ve)return $("AI 리포트를 이미 진행하고 있습니다."),ve;if(!i.analysis||!i.organizationProfile)return $("먼저 확인 목록을 갱신한 뒤 보고서를 작성하세요."),Promise.resolve();if(i.analysisStale)return $("진단이 변경되었습니다. 확인 목록을 먼저 갱신하세요."),Promise.resolve();Ze=new AbortController;const s=Sr(e,Ze.signal).finally(()=>{ve===s&&(ve=null,Ze=null)});return ve=s,ve}async function Sr({domainChecksPayload:e,renderAnalyzeView:t},s){const n=i.activeSessionId,a=()=>!s.aborted&&i.activeSessionId===n;i.aiReportWriting=!0,j();const r=p("executiveReportStream");r&&(r.dataset.userEdited="0");try{const o=await Se("/controls/report",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Fn(e)),signal:s});if(!a())return;o.clientAnalyzedAt=Date.now(),i.analysis=o,i.lastAiExecutiveReport=o.executiveReport||"",i.aiReportStale=!1,i.analysisStale=!1,[p("analysisStaleNoticeInline")].filter(Boolean).forEach(l=>{l.hidden=!0}),Dn(o),t?.(!0),ts(),re(o),o.verbalizeMeta,i.aiReportWriting=!1,j(),o.executiveReport?await Yi(o.executiveReport):He(),$("AI 리포트를 마쳤습니다.")}catch(o){if(o.name==="AbortError"||!a())return;console.warn(o),He(),j(),$(`AI 리포트 실패: ${o.message}`)}finally{a()&&(i.aiReportWriting=!1,j())}}async function kr(e,t={},{showProfileWizard:s,switchView:n,domainChecksPayload:a,renderProfileContext:r,renderStats:o,syncAssessmentsFromApplicability:l,renderAnalyzeView:d},u){if(!i.organizationProfile){s(),$("먼저 점검 범위를 적용한 뒤 확인 목록을 만드세요.");return}const f=i.activeSessionId,m=()=>!u.aborted&&i.activeSessionId===f,g=p("analysisReportPanel"),h=p("analyzeContent"),b=p("workspaceLoadingSkeleton"),A=p("view-analyze");e!==!1&&(n("analyze",{skipAutoAnalyze:!0}),h.style.display="none",g&&(g.style.display="none"),b&&(b.hidden=!1,b.dataset.analysisLoading="true",b.dataset.loadingSessionId=f||""),A?.classList.add("is-workspace-loading"),A?.setAttribute("aria-busy","true"));try{const E=await Se("/controls/analyze",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Fn(a)),signal:u});if(!m())return;const y=!!i.lastAiExecutiveReport;if(E.clientAnalyzedAt=Date.now(),i.analysis=E,i.reportReview={},i.analysisStale=!1,i.aiReportStale=y,[p("analysisStaleNoticeInline")].filter(Boolean).forEach(x=>{x.hidden=!0}),i.scopeDraft=E.scopeDraft||i.scopeDraft,r(),l(E),ge(),o(),i.analyzeSection="actions",de("actions"),h&&(h.style.display="",h.classList.add("analyze-content-fade")),d(!0),!m()||(Dn(E),ts(),g&&(g.style.display="",re(E),E.verbalizeMeta,He({preferTemplate:!y}),j()),!m()))return;e!==!1&&n("analyze",{skipAutoAnalyze:!0}),t.successToast&&$(t.successToast)}catch(E){if(E.name==="AbortError"||!m())return;h&&(h.style.display=""),g&&(g.style.display="none"),$("확인 목록 생성 실패: "+E.message)}finally{b?.dataset.loadingSessionId===(f||"")&&(b.hidden=!0,delete b.dataset.analysisLoading,delete b.dataset.loadingSessionId,A?.classList.remove("is-workspace-loading"),A?.removeAttribute("aria-busy"))}}function Cr(){let e=document.getElementById("defectEvidenceDialog");return e||(e=document.createElement("dialog"),e.id="defectEvidenceDialog",e.className="app-modal defect-evidence-dialog",e.setAttribute("aria-labelledby","defectEvidenceTitle"),e.innerHTML='<div class="app-modal-shell defect-dialog-shell"><header class="app-modal-header"><div><span class="app-modal-eyebrow">우선순위 산정 근거</span><h3 id="defectEvidenceTitle"></h3><p>선정 근거와 참고 사례를 구분해 확인하세요.</p></div><button type="button" class="app-modal-close" data-close-defect-dialog aria-label="우선순위 근거 창 닫기">×</button></header><div id="defectEvidenceBody" class="app-modal-scroll defect-dialog-body"></div></div>',document.body.appendChild(e),e.querySelector("[data-close-defect-dialog]")?.addEventListener("click",()=>e.close()),e.addEventListener("click",t=>{t.target===e&&e.close()}),e)}function Ar(e){const t=e?.defectEvidence;if(!t)return;const s=Cr(),n=s.querySelector("#defectEvidenceTitle"),a=s.querySelector("#defectEvidenceBody");n&&(n.textContent=`${e.controlId} ${e.title}`),a&&(a.innerHTML=`
    ...
    <p class="defect-dialog-caution">과거 결함 빈도는 점검 순서를 정하기 위한 참고 근거입니다. 현재 조직에서 같은 결함이 발생했다는 판정은 아닙니다.</p>`),s.showModal()}function Er(e){const t=p("gapClustersPanel"),s=p("gapClusters"),n=p("gapClustersEmpty"),a=p("gapClustersCount");if(!(!t||!s)){if(a&&(a.textContent=`${(e||[]).length}개 묶음`),!e||!e.length){$s(t,n,!0,[s]),n&&(n.innerHTML=Oi(i.analysis||{})),s.innerHTML="";return}$s(t,n,!1,[s]),s.innerHTML=e.map(r=>{const o=r.controls||[],l=r.primaryControl||o[0]||null,d=o.filter(u=>u.controlId!==l?.controlId);return`
        ...
        ${d.length?`
          <div class="gap-cluster-related">
            ...
            <div class="related-chips">
              ${d.map(u=>{const f=`${u.controlId} ${u.title} · ${u.levelLabel}. ${u.nextAction||"클릭하면 해당 통제로 이동합니다."}`;return`<button type="button" class="related-chip ui-tip" data-jump-control="${c(u.controlId)}" data-tip="${c(Cs(f))}" title="${c(Cs(f))}">${c(u.controlId)}</button>`}).join("")}
            </div>
          </div>
        `:""}
      </article>
    `}).join(""),s.querySelectorAll("[data-open-defect-evidence]").forEach(r=>{r.addEventListener("click",()=>{const o=e.find(l=>l.primaryControl?.controlId===r.dataset.openDefectEvidence)?.primaryControl;Ar(o)})})}}function Lr(e,{renderConfirmationActions:t}){const s=i.analysis;if(!s)return;if(!e){p("analyzeContent").style.display="";const v=p("analysisReportPanel");v&&(s.executiveReport||i.lastAiExecutiveReport)&&(v.style.display="",He(),re(s))}const n=s.areaCoverage||{},a=(s.categoryCoverage||s.weakCategories||[]).map(v=>{const S=Number(v.reviewedCount??0),w=Number(v.totalCount??v.count??0),k=Number.isFinite(Number(v.coveragePercent))?Number(v.coveragePercent):w>0?S/w*100:0,I=Qe(k);return{...v,reviewed:S,total:w,pct:I}}),r=a.reduce((v,S)=>v+S.reviewed,0),o=a.reduce((v,S)=>v+S.total,0),l=Qe(o>0?r/o*100:0),d=o>0&&r>=o,u=p("categoryCoverageSummary"),f=p("categoryCoverageList"),m=p("categoryListCount");if(m&&(m.textContent=`중분류 ${a.length}개 · 스크롤하여 전체 보기`),u&&(u.classList.toggle("is-complete",d),u.innerHTML=o?`
      <div class="category-summary-copy" role="status">
        <strong>${d?`적용 통제 ${o}개 점검 완료`:`통제 ${r}/${o}개 점검 완료`}</strong>
        <span>전체 점검 진행률 ${ks(l)}%</span>
    ...
    `:""),f){const v=new Map;a.forEach(S=>{const w=S.areaId||S.areaName||String(S.categoryId||"기타").split(".")[0];if(!v.has(w)){const k=S.areaName||"기타";v.set(w,{areaName:k,coverage:n[k]||null,items:[]})}v.get(w).items.push(S)}),f.hidden=a.length===0,f.innerHTML=Array.from(v.values()).map(S=>{const w=S.items.sort((C,T)=>String(C.categoryId||"").localeCompare(String(T.categoryId||""),void 0,{numeric:!0})),k=Number(S.coverage?.reviewedCount??w.reduce((C,T)=>C+T.reviewed,0)),I=Number(S.coverage?.totalCount??w.reduce((C,T)=>C+T.total,0)),z=Qe(S.coverage?.coveragePercent??(I?k/I*100:0));return`
  ...
  `}function Mr(e,t){if(!e||e.classList.contains("is-renaming")||typeof t!="function")return;const s=e.querySelector(".diagnosis-session-name");if(!s)return;const n=s.textContent||"",a=document.createElement("input");a.type="text",a.className="diagnosis-session-name-input",a.value=n,a.maxLength=Ks,a.setAttribute("aria-label","진단 이름"),a.autocomplete="off",a.spellcheck=!1,e.classList.add("is-renaming"),s.replaceWith(a),a.focus(),a.select();let r=!1;const o=()=>{a.isConnected&&(a.replaceWith(s),e.classList.remove("is-renaming"))},l=d=>{if(r)return;r=!0;const u=a.value.replace(/\s+/g," ").trim();if(!d){o();return}if(!u){o(),$("진단 이름을 입력해 주세요.",{tone:"warning"});return}t(e.dataset.sessionId,u)};a.addEventListener("keydown",d=>{d.key==="Enter"&&(d.preventDefault(),a.blur(),l(!0)),d.key==="Escape"&&(d.preventDefault(),l(!1))}),a.addEventListener("blur",()=>l(!0))}function St(e,t,s={}){const n=s.current?' aria-current="page"':"",a=s.disabled?" disabled":"",r=s.ariaLabel?` aria-label="${c(s.ariaLabel)}"`:"";return`<button type="button" data-session-page="${e}"${n}${a}${r}>${t}</button>`}function Nr(e,t,s){if(!e)return;if(s<=1){e.hidden=!0,e.innerHTML="";return}e.hidden=!1;const n=Tr(t,s),a=[St(t-1,'<svg aria-hidden="true" viewBox="0 0 20 20"><path d="M12 5 7 10l5 5"/></svg>',{disabled:t<=1,ariaLabel:"이전 페이지"})];let r=0;n.forEach(o=>{r&&o>r+1&&a.push('<span class="diagnosis-session-pager-gap" aria-hidden="true">...</span>'),a.push(St(o,String(o),{current:o===t,ariaLabel:`${o}페이지`})),r=o}),a.push(St(t+1,'<svg aria-hidden="true" viewBox="0 0 20 20"><path d="m8 5 5 5-5 5"/></svg>',{disabled:t>=s,ariaLabel:"다음 페이지"})),e.innerHTML=a.join(""),e.querySelectorAll("[data-session-page]").forEach(o=>{o.addEventListener("click",()=>{const l=Number(o.dataset.sessionPage);!Number.isInteger(l)||l===ze||(ze=l,Dt&&Un(Dt))})})}function Un({onOpen:e,onCreate:t,onDuplicate:s,onRename:n,onExport:a,onImport:r,onDelete:o}){const l=p("diagnosisSessionList");if(!l)return;Dt={onOpen:e,onCreate:t,onDuplicate:s,onRename:n,onExport:a,onImport:r,onDelete:o};const d=[...i.diagnosisSessions].sort((h,b)=>new Date(b.updatedAt).getTime()-new Date(h.updatedAt).getTime()),u=Ir(d,ze);ze=u.current,l.innerHTML=u.total?u.items.map(Pr).join(""):`
      <section class="diagnosis-session-empty" role="status">
        <strong>저장된 진단이 없습니다</strong>
        <p>새 진단을 만들면 현재 브라우저에 독립된 진단 프로젝트로 저장됩니다.</p>
      </section>
    `,Nr(p("diagnosisSessionPager"),u.current,u.total?u.pageCount:0),l.querySelectorAll("[data-session-open]").forEach(h=>{h.addEventListener("click",()=>{e(h.closest("[data-session-id]")?.dataset.sessionId)})}),l.querySelectorAll("[data-session-rename]").forEach(h=>{h.addEventListener("click",()=>{Mr(h.closest("[data-session-id]"),n)})}),l.querySelectorAll("[data-session-duplicate]").forEach(h=>{h.addEventListener("click",()=>{s(h.closest("[data-session-id]")?.dataset.sessionId)})}),l.querySelectorAll("[data-session-delete]").forEach(h=>{h.addEventListener("click",()=>{o(h.closest("[data-session-id]")?.dataset.sessionId)})}),l.querySelectorAll("[data-session-export]").forEach(h=>{h.addEventListener("click",()=>{a(h.closest("[data-session-id]")?.dataset.sessionId)})});const f=p("createDiagnosisSessionBtn");f&&(f.onclick=t);const m=p("importDiagnosisSessionBtn"),g=p("importDiagnosisSessionInput");m&&g&&(m.onclick=()=>g.click(),g.onchange=async()=>{const h=g.files?.[0];g.value="",h&&await r(h)})}function ot(){const e=p("sessionPicker"),t=p("appMain");e&&(e.hidden=!1),t&&(t.hidden=!0)}function ns(){const e=p("sessionPicker"),t=p("appMain");e&&(e.hidden=!0),t&&(t.hidden=!1)}let et=!1,kt=!1,Ct=null;function Dr(){if(!Ct){if(!document.querySelector("link[data-report-editor-style]")){const t=document.createElement("link");t.rel="stylesheet",t.href="/controls/map/assets/react-dist/report-editor.css?v=20260820-1",t.dataset.reportEditorStyle="1",document.head.append(t)}Ct=import("/controls/map/assets/react-dist/report-editor.js?v=20260820-1")}return Ct}let oe=null;async function qr(e,{toastMessage:t,runAnalyzeAfter:s=!0,switchToAnalyze:n=!0}={}){La(e),i.analyzeScenarioId=null,i.sessionBundleMode=i.sessionBundleMode||"chain",i.pendingProfile=null,i.analysis=null,kn(),Jt(),Be(),s?await ft(n,{successToast:t||!1,loadingMode:"priority"}):t&&$(t)}function Br(){le("scope")}function Or(e={}){return i.analysis||!i.organizationProfile?null:ft(!0,{loadingMode:e.loadingMode||"priority",successToast:e.successToast||!1})}function Gn(){if(!i.analysis)return;i.analysisStale=!0,i.lastAiExecutiveReport&&(i.aiReportStale=!0);const e=p("analysisStaleNoticeInline");e&&(e.hidden=!1);const t=p("reportReturnStatus");i.reportReturn&&t&&(t.textContent="진단이 변경되었습니다. 돌아간 뒤 확인 목록을 갱신하세요."),j()}function jr(){const e=i.reportReturn;i.reportReturn=null;const t=p("reportReturnBar");t&&(t.hidden=!0),le("report",{replace:!0});const s=p("analyzeContent");s&&(s.style.display="");const n=p("analysisReportPanel");n&&(n.style.display=""),i.analysis&&re(i.analysis),window.requestAnimationFrame(()=>{const a=p("reportReviewQueue"),r=[...a?.querySelectorAll("[data-review-item-id]")||[]].find(l=>l.dataset.reviewItemId===e?.itemId);if(r){const l=r.querySelector("[data-review-related-toggle]"),d=r.querySelector("[data-review-related-panel]");l&&d&&(d.hidden=!1,l.setAttribute("aria-expanded","true"),l.textContent="관련 통제 접기"),e?.controlId&&r.querySelector(`[data-review-open-control="${CSS.escape(e.controlId)}"]`)?.classList.add("is-return-focus")}(r||a||n)?.scrollIntoView({behavior:"smooth",block:"center"}),r&&(r.setAttribute("tabindex","-1"),r.focus({preventScroll:!0}))})}function Es(e){const t=Le[e]?e:"assess",s=p("pageKicker"),n=p("pageTitle"),a=p("heroLede");s&&(s.textContent=os[t]||os.assess),n&&(n.textContent=Le[t]||Le.assess),a&&(a.textContent=rs[t]||rs.assess),p("workspaceContextTitle")&&(p("workspaceContextTitle").textContent=Le[t]||Le.assess),p("workspaceContextDetail")&&(p("workspaceContextDetail").textContent=t==="assess"?"진단 환경 설정":"통제 진단 현황")}function ut(e="assessment"){const t=p("view-analyze");if(!t)return;const s=["assessment","results","evidence","report"],n=s.includes(e)?e:"assessment";n==="report"&&Dr(),s.forEach(f=>t.classList.toggle(`is-${f}`,f===n));const a={assessment:["진단","자가진단","통제별 판단 기준을 확인하고 진단 결과를 저장하세요."],results:["진단","진단 결과","확인된 미흡과 연계 리스크, 보완 우선순위를 확인하세요."],evidence:["관리","증적 관리","통제별 증적 등록 상태를 확인하고 부족한 근거를 보완하세요."],report:["관리","보고서","진단 초안을 검토한 뒤 본문을 수정하고 내보내세요."]},[r,o,l]=a[n];p("pageKicker")&&(p("pageKicker").textContent=r),p("pageTitle")&&(p("pageTitle").textContent=o),p("heroLede")&&(p("heroLede").textContent=l),p("workspaceContextTitle")&&(p("workspaceContextTitle").textContent=o);const d={assessment:"통제별 진단 및 판단",results:"보완 우선순위와 진단 결과",evidence:"통제별 증적 등록 현황",report:"진단 결과 보고서"};p("workspaceContextDetail")&&(p("workspaceContextDetail").textContent=d[n]),n==="assessment"||n==="evidence"?de("actions"):n==="results"&&de("overview"),n==="report"&&(He(),j());const u=p("workspaceLoadingSkeleton");u&&u.setAttribute("aria-label",n==="report"?"보고서를 불러오는 중":"진단 항목을 불러오는 중"),window.scrollTo({top:0,behavior:"auto"})}function pt(){const e=dn(),t=un(),s=p("pageHeadStatus");if(!s)return;const n=i.currentView==="analyze"&&!!i.organizationProfile;if(s.hidden=!n,!n)return;const a=t>0&&e>=t,r=An().length,o=(i.checklist||[]).filter(m=>L(m.id)==="partial").length,l=Ln({done:r,partial:o,applicable:t}),d=Yt(l);s.classList.toggle("is-complete",a),s.classList.toggle("is-temperature",!0),s.classList.remove("is-cold","is-warming","is-rising","is-ready"),s.classList.add(`is-${d.key}`);const u=p("pageHeadStatusLabel"),f=p("pageHeadStatusMeta");u&&(u.textContent=`${l}°`),f&&(f.textContent=d.label)}function ue(e,t={}){if(!t.skipProfileGate&&(e==="assess"||e==="analyze")&&!i.organizationProfile){i.currentView="assess",document.querySelectorAll(".view-panel").forEach(s=>{const n=s.id==="view-assess";s.classList.toggle("active",n),s.hidden=!n}),Es("assess"),Pt(),$("먼저 점검 범위를 적용하세요.");return}if(i.currentView=e,document.querySelectorAll(".view-panel").forEach(s=>{const n=s.id===`view-${e}`;s.classList.toggle("active",n),s.hidden=!n}),Es(e),e==="assess"&&i.organizationProfile&&Pt({focus:!1}),e==="analyze"){const s=p("view-analyze"),n=["assessment","results","evidence","report"].find(a=>s?.classList.contains(`is-${a}`));if(ut(n||"assessment"),de(i.analyzeSection||"actions"),i.analysis){as(!0);const a=p("analyzeContent"),r=p("analysisReportPanel");a&&(a.style.display=""),r&&(r.style.display="")}else t.skipAutoAnalyze||Or()}pt()}function Wn(e){Pn(e,{diagnoseControl:pi,markAnalysisStale:Gn})}function Hr(){return $r({domainChecksPayload:vn,renderAnalyzeView:as})}function ft(e,t={}){return wr(e,{loadingMode:"priority",...t},{showProfileWizard:Br,switchView:ue,domainChecksPayload:vn,renderProfileContext:Jt,renderStats:pt,syncAssessmentsFromApplicability:Ya,renderAnalyzeView:as})}function as(e){Lr(e,{renderConfirmationActions:Wn})}function pe(){Un({onOpen:is,onCreate:Wr,onDuplicate:Vr,onRename:Kr,onExport:Yr,onImport:Qr,onDelete:Xr})}function Fr(){le("sessions")}function zr(e){document.title="ONDO°"}function _r(e){document.querySelectorAll(".sidebar-nav a[data-route]").forEach(t=>{const s=t.dataset.route===e;t.classList.toggle("is-active",s),s?t.setAttribute("aria-current","page"):t.removeAttribute("aria-current")})}function Ur(e,{replace:t=!1,skipHistory:s=!1}={}){const n=U[e]||U.sessions;if(s)return;const a=ct(window.location.pathname);if(a?.id===n.id&&!t)return;const r=t||!a?"replaceState":"pushState";window.history[r]({routeId:n.id},"",n.path)}function Gr(){const e=ct(window.location.pathname);return e&&e.id!=="sessions"?e.id:i.organizationProfile?"assessment":"scope"}function _e(e,t={}){const s=U[e]||U.sessions;if(Ur(s.id,t),zr(s.id),_r(s.id),s.id==="sessions"){oe=null,zn(),pe(),ot(),window.scrollTo({top:0,behavior:"auto"});return}if(!i.activeSessionId){oe=s.id,pe(),ot(),window.scrollTo({top:0,behavior:"auto"});return}if(oe=null,ns(),s.id==="scope"){ue("assess",{skipProfileGate:!0}),Pt(),window.scrollTo({top:0,behavior:"auto"});return}if(!i.organizationProfile){$("먼저 점검 범위를 적용하세요."),_e("scope",{replace:!0});return}ut(s.workspace||"assessment"),ue("analyze")}async function is(e){if(kt)return;if(zn(),!Ut(e)){$("선택한 진단을 찾을 수 없습니다."),pe();return}kt=!0;const s=p("workspaceLoadingSkeleton");try{ns(),Be(),kn();const n=oe&&oe!=="sessions"?oe:Gr();if(i.organizationProfile&&n!=="scope"){const a=U[n]||U.assessment;ut(a.workspace||"assessment"),ue("analyze",{skipAutoAnalyze:!0}),!et&&s&&(s.hidden=!1,p("view-analyze")?.classList.add("is-workspace-loading"),p("view-analyze")?.setAttribute("aria-busy","true"))}if(!et){const[a,r]=await Promise.all([Se("/controls/dashboard"),Se("/controls/checklist?compact=true")]);i.dashboard=a,i.allControls=r.controls,await ui(r),et=!0}Jt(),pt(),_e(n,{replace:!0}),window.scrollTo({top:0,behavior:"auto"})}catch(n){Fr(),$(`진단을 불러오지 못했습니다: ${n.message}`)}finally{s?.dataset.analysisLoading!=="true"&&(s.hidden=!0,p("view-analyze")?.classList.remove("is-workspace-loading"),p("view-analyze")?.removeAttribute("aria-busy")),kt=!1}}function Wr(){const e=wa();is(e.id)}function Vr(e){$a(e)&&(_n(),pe())}function Kr(e,t){const s=i.diagnosisSessions.find(a=>a.id===e);if(!s)return!1;const n=Sa(e,t);return n?(pe(),n.name!==s.name&&$(`진단 이름을 “${n.name}”(으)로 바꿨습니다.`),!0):!1}function Jr(e){return`${String(e||"진단").replace(/[\\/:*?"<>|]/g,"-").replace(/\s+/g," ").trim().slice(0,60)||"진단"}-백업.json`}function Yr(e){try{const t=ka(e),s=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),n=URL.createObjectURL(s),a=document.createElement("a");a.href=n,a.download=Jr(t.session.name),document.body.appendChild(a),a.click(),a.remove(),URL.revokeObjectURL(n),$("진단 백업을 저장했습니다. 다른 브라우저에서 ‘백업 가져오기’를 사용하세요.")}catch(t){$(`백업을 만들지 못했습니다: ${t.message}`)}}async function Qr(e){if(e.size>5*1024*1024){$("백업 파일은 5MB 이하만 가져올 수 있습니다.");return}try{const t=Ca(await e.text());if(!await Ht({title:`“${t.name}” 진단을 가져올까요?`,message:`점검 ${t.progress.reviewed}/${t.progress.applicable}개가 포함되어 있습니다. 기존 진단은 유지되고 새 진단으로 추가됩니다.`,confirmLabel:"새 진단으로 가져오기"}))return;const n=Aa(t);_n(),pe(),$(`${n.name}을(를) 가져왔습니다.`)}catch(t){$(`백업을 가져오지 못했습니다: ${t.message}`)}}async function Xr(e){const t=i.diagnosisSessions.find(n=>n.id===e);!t||!await Ht({title:`${t.name} 진단을 삭제할까요?`,message:"진단 상태와 증적 정보가 함께 삭제되며 되돌릴 수 없습니다.",confirmLabel:"진단 삭제",tone:"danger"})||(Ea(e),pe(),$("진단을 삭제했습니다."))}function Zr(){Gi(),Vi(),document.addEventListener("click",e=>{const t=e.target.closest("a[data-route]");t&&(e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||e.button!==0||(e.preventDefault(),le(t.dataset.route)))}),document.addEventListener("click",e=>{e.target.closest("[data-run-analysis]")&&ft(!0,{loadingMode:"priority",successToast:"확인 목록을 갱신했습니다."})}),document.querySelectorAll("[data-write-ai-report]").forEach(e=>{e.addEventListener("click",async()=>{!await Ws()||p("executiveReportStream")?.dataset.userEdited==="1"&&!await Ht({title:"AI 초안으로 바꿀까요?",message:"직접 고친 본문이 AI 초안으로 대체됩니다.",confirmLabel:"다시 작성",cancelLabel:"편집 유지"})||Hr()})}),p("profileForm").addEventListener("submit",async e=>{if(e.preventDefault(),!it()){$("클라우드 또는 자체 인프라를 하나 이상 선택하세요."),p("profileCloud")?.focus();return}const t=p("applyProfileBtn");t&&(t.disabled=!0);try{await qr(dt(),{runAnalyzeAfter:!0,switchToAnalyze:!0}),le("assessment",{replace:!0})}catch(s){$("환경 적용 실패: "+s.message)}finally{t&&(t.disabled=!it())}}),["profileCloud","profileOnPrem"].forEach(e=>{p(e)?.addEventListener("change",Sn)}),p("returnToReportBtn")?.addEventListener("click",jr),tr({navigateToControl:wn}),p("exportReportBtn")?.addEventListener("click",Zi),p("exportReportDocxBtn")?.addEventListener("click",er),p("resetReportBtn")?.addEventListener("click",Ki),window.addEventListener("popstate",()=>{const e=ct(window.location.pathname);_e(e?.id||"sessions",{skipHistory:!0})})}function eo(e){if(!i.activeSessionId||e==="sessions"||!Ut(i.activeSessionId))return ot(),!1;if(oe=e,ns(),e==="scope"||!i.organizationProfile)return ue("assess",{skipProfileGate:!0}),!0;const s=U[e]||U.assessment;ut(s.workspace||"assessment"),ue("analyze",{skipAutoAnalyze:!0});const n=p("workspaceLoadingSkeleton");return!et&&n&&(n.hidden=!1,p("view-analyze")?.classList.add("is-workspace-loading"),p("view-analyze")?.setAttribute("aria-busy","true")),!0}async function to(){si({markAnalysisStale:Gn,renderConfirmationActions:Wn,renderStats:pt,runAnalysis:ft,switchView:ue,switchAnalyzeSection:de}),Va(_e),ba(),ta(),Zr();const t=ct(window.location.pathname)?.id||"sessions",s=eo(t);if(await ea(),s&&i.activeSessionId){await is(i.activeSessionId);return}_e(t,{replace:!0})}const Vn="ondo.narrowWorkspaceContinue",At="is-narrow-workspace-ok",so="(max-width: 860px), (max-height: 520px) and (pointer: coarse)";function no(){try{return sessionStorage.getItem(Vn)==="1"}catch{return!1}}function ao(){try{sessionStorage.setItem(Vn,"1")}catch{}}function io(e){const t=document.getElementById("desktopWorkspaceGate");Array.from(document.body.children).forEach(s=>{s!==t&&(e?s.setAttribute("inert",""):s.removeAttribute("inert"))})}async function ro(e){if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(e);return}const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove()}function oo(){const e=document.getElementById("desktopWorkspaceGate");if(!e)return;const t=window.matchMedia(so),s=document.getElementById("desktopWorkspaceGateUrl"),n=document.getElementById("desktopWorkspaceGateCopy"),a=document.getElementById("desktopWorkspaceGateContinue"),r=document.getElementById("desktopWorkspaceGateTitle");function o(){no()&&document.documentElement.classList.add(At);const l=t.matches&&!document.documentElement.classList.contains(At);e.setAttribute("aria-hidden",l?"false":"true"),s&&(s.textContent=window.location.href),io(l),l&&r&&document.activeElement===document.body&&r.focus()}n?.addEventListener("click",async()=>{const l=window.location.href;try{await ro(l);const d=n.textContent;n.textContent="복사됨",window.setTimeout(()=>{n.textContent=d},1600)}catch{n.textContent="아래 주소를 길게 누르세요"}}),a?.addEventListener("click",()=>{ao(),document.documentElement.classList.add(At),o()}),typeof t.addEventListener=="function"?t.addEventListener("change",o):typeof t.addListener=="function"&&t.addListener(o),window.addEventListener("popstate",o),o()}function Ls(){oo(),to()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ls):Ls();
